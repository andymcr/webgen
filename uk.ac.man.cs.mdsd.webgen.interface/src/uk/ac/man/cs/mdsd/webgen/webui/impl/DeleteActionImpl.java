...
public class DeleteActionImpl extends InlineActionImpl implements DeleteAction {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.DELETE_ACTION;
	}
		...
		if (destination != null && destination.eIsProxy()) {
			...
			if (destination != oldDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.DELETE_ACTION__DESTINATION, oldDestination, destination));
			}
		}
		return destination;
	}
	...
	public void setDestination(Page newDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DELETE_ACTION__DESTINATION, oldDestination, destination));
	}
	...
	public void setConfirmMessage(String newConfirmMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DELETE_ACTION__CONFIRM_MESSAGE, oldConfirmMessage, confirmMessage));
	}
	...
	public void setUriElement(String newUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DELETE_ACTION__URI_ELEMENT, oldUriElement, uriElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.DELETE_ACTION__DESTINATION:
				if (resolve) return getDestination();
				return basicGetDestination();
			case WebGenWebUIPackage.DELETE_ACTION__CONFIRM_MESSAGE:
				return getConfirmMessage();
			case WebGenWebUIPackage.DELETE_ACTION__URI_ELEMENT:
