 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFieldImpl#getDisplayedOn <em>Displayed On</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFieldImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFieldImpl#getCollectionDisplayOption <em>Collection Display Option</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFieldImpl#isCollectionAllowAdd <em>Collection Allow Add</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFieldImpl#isCollectionAllowRemove <em>Collection Allow Remove</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFieldImpl#getMaximumDisplaySize <em>Maximum Display Size</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFieldImpl#getDateFormat <em>Date Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UnitFieldImpl extends MinimalEObjectImpl.Container implements UnitField {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.UNIT_FIELD;
	}
	...
	public DynamicUnit getDisplayedOn() {
		if (eContainerFeatureID() != WebGenInterfacePackage.UNIT_FIELD__DISPLAYED_ON) return null;
	...
	public NotificationChain basicSetDisplayedOn(DynamicUnit newDisplayedOn, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDisplayedOn, WebGenInterfacePackage.UNIT_FIELD__DISPLAYED_ON, msgs);
		return msgs;
	}
	...
	public void setDisplayedOn(DynamicUnit newDisplayedOn) {
		if (newDisplayedOn != eInternalContainer() || (eContainerFeatureID() != WebGenInterfacePackage.UNIT_FIELD__DISPLAYED_ON && newDisplayedOn != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FIELD__DISPLAYED_ON, newDisplayedOn, newDisplayedOn));
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FIELD__TITLE, oldTitle, title));
	}
	...
	public void setCollectionDisplayOption(CollectionDisplayOptions newCollectionDisplayOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FIELD__COLLECTION_DISPLAY_OPTION, oldCollectionDisplayOption, collectionDisplayOption));
	}
	...
	public void setCollectionAllowAdd(boolean newCollectionAllowAdd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FIELD__COLLECTION_ALLOW_ADD, oldCollectionAllowAdd, collectionAllowAdd));
	}
	...
	public void setCollectionAllowRemove(boolean newCollectionAllowRemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FIELD__COLLECTION_ALLOW_REMOVE, oldCollectionAllowRemove, collectionAllowRemove));
	}
	...
	public void setMaximumDisplaySize(int newMaximumDisplaySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FIELD__MAXIMUM_DISPLAY_SIZE, oldMaximumDisplaySize, maximumDisplaySize));
	}
	...
	public void setDateFormat(String newDateFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FIELD__DATE_FORMAT, oldDateFormat, dateFormat));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenInterfacePackage.UNIT_FIELD__DISPLAYED_ON:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WebGenInterfacePackage.UNIT_FIELD__TITLE:
				return getTitle();
			case WebGenInterfacePackage.UNIT_FIELD__COLLECTION_DISPLAY_OPTION:
				return getCollectionDisplayOption();
			case WebGenInterfacePackage.UNIT_FIELD__COLLECTION_ALLOW_ADD:
				return isCollectionAllowAdd();
			case WebGenInterfacePackage.UNIT_FIELD__COLLECTION_ALLOW_REMOVE:
				return isCollectionAllowRemove();
			case WebGenInterfacePackage.UNIT_FIELD__MAXIMUM_DISPLAY_SIZE:
				return getMaximumDisplaySize();
			case WebGenInterfacePackage.UNIT_FIELD__DATE_FORMAT:
