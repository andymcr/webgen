 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.InlineActionImpl#getUsedBy <em>Used By</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.InlineActionImpl#isDisable <em>Disable</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.InlineActionImpl#getRequiresRole <em>Requires Role</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.InlineActionImpl#getEnableWhen <em>Enable When</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.InlineActionImpl#getDisplayWhen <em>Display When</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.InlineActionImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.InlineActionImpl#getFooter <em>Footer</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.InlineActionImpl#getHeaderClass <em>Header Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.InlineActionImpl#getFooterClass <em>Footer Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class InlineActionImpl extends NamedDisplayElementImpl implements InlineAction {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.INLINE_ACTION;
	}
	...
	public InlineActionContainer getUsedBy() {
		if (eContainerFeatureID() != WebGenInterfacePackage.INLINE_ACTION__USED_BY) return null;
	...
	public NotificationChain basicSetUsedBy(InlineActionContainer newUsedBy, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newUsedBy, WebGenInterfacePackage.INLINE_ACTION__USED_BY, msgs);
		return msgs;
	}
	...
	public void setUsedBy(InlineActionContainer newUsedBy) {
		if (newUsedBy != eInternalContainer() || (eContainerFeatureID() != WebGenInterfacePackage.INLINE_ACTION__USED_BY && newUsedBy != null)) {
			...
			if (newUsedBy != null)
				msgs = ((InternalEObject)newUsedBy).eInverseAdd(this, WebGenInterfacePackage.INLINE_ACTION_CONTAINER__ACTIONS, InlineActionContainer.class, msgs);
			msgs = basicSetUsedBy(newUsedBy, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__USED_BY, newUsedBy, newUsedBy));
	}
	...
	public void setDisable(boolean newDisable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__DISABLE, oldDisable, disable));
	}
	...
	public void setRequiresRole(String newRequiresRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__REQUIRES_ROLE, oldRequiresRole, requiresRole));
	}
	...
	public NotificationChain basicSetEnableWhen(Predicate newEnableWhen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__ENABLE_WHEN, oldEnableWhen, newEnableWhen);
	...
	public void setEnableWhen(Predicate newEnableWhen) {
		if (newEnableWhen != enableWhen) {
			NotificationChain msgs = null;
			if (enableWhen != null)
				msgs = ((InternalEObject)enableWhen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.INLINE_ACTION__ENABLE_WHEN, null, msgs);
			if (newEnableWhen != null)
				msgs = ((InternalEObject)newEnableWhen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.INLINE_ACTION__ENABLE_WHEN, null, msgs);
			msgs = basicSetEnableWhen(newEnableWhen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__ENABLE_WHEN, newEnableWhen, newEnableWhen));
	}
	...
	public NotificationChain basicSetDisplayWhen(Predicate newDisplayWhen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__DISPLAY_WHEN, oldDisplayWhen, newDisplayWhen);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDisplayWhen(Predicate newDisplayWhen) {
		if (newDisplayWhen != displayWhen) {
			NotificationChain msgs = null;
			if (displayWhen != null)
				msgs = ((InternalEObject)displayWhen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.INLINE_ACTION__DISPLAY_WHEN, null, msgs);
			if (newDisplayWhen != null)
				msgs = ((InternalEObject)newDisplayWhen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.INLINE_ACTION__DISPLAY_WHEN, null, msgs);
			msgs = basicSetDisplayWhen(newDisplayWhen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__DISPLAY_WHEN, newDisplayWhen, newDisplayWhen));
	}
	...
	public void setHeader(String newHeader) {
		...
		header = newHeader;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__HEADER, oldHeader, header));
	}
	...
	public void setFooter(String newFooter) {
		...
		footer = newFooter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__FOOTER, oldFooter, footer));
	}
	...
	public void setHeaderClass(String newHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__HEADER_CLASS, oldHeaderClass, headerClass));
	}
	...
	public void setFooterClass(String newFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.INLINE_ACTION__FOOTER_CLASS, oldFooterClass, footerClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenInterfacePackage.INLINE_ACTION__USED_BY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WebGenInterfacePackage.INLINE_ACTION__ENABLE_WHEN:
				return basicSetEnableWhen(null, msgs);
			case WebGenInterfacePackage.INLINE_ACTION__DISPLAY_WHEN:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case WebGenInterfacePackage.INLINE_ACTION__USED_BY:
				return eInternalContainer().eInverseRemove(this, WebGenInterfacePackage.INLINE_ACTION_CONTAINER__ACTIONS, InlineActionContainer.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.INLINE_ACTION__USED_BY:
				return getUsedBy();
			case WebGenInterfacePackage.INLINE_ACTION__DISABLE:
				return isDisable();
			case WebGenInterfacePackage.INLINE_ACTION__REQUIRES_ROLE:
				return getRequiresRole();
			case WebGenInterfacePackage.INLINE_ACTION__ENABLE_WHEN:
				return getEnableWhen();
			case WebGenInterfacePackage.INLINE_ACTION__DISPLAY_WHEN:
				return getDisplayWhen();
			case WebGenInterfacePackage.INLINE_ACTION__HEADER:
				return getHeader();
			case WebGenInterfacePackage.INLINE_ACTION__FOOTER:
				return getFooter();
			case WebGenInterfacePackage.INLINE_ACTION__HEADER_CLASS:
				return getHeaderClass();
			case WebGenInterfacePackage.INLINE_ACTION__FOOTER_CLASS:
