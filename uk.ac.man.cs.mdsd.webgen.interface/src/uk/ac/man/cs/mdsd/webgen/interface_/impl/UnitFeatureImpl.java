 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#getActions <em>Actions</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#isOnlyDisplayWhenNotEmpty <em>Only Display When Not Empty</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#getDisplayLabel <em>Display Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#getForcedValue <em>Forced Value</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#getNullDisplayValue <em>Null Display Value</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#getFooter <em>Footer</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#isAutofocus <em>Autofocus</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#getHeaderClass <em>Header Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#getInputClass <em>Input Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#getDisplayClass <em>Display Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitFeatureImpl#getFooterClass <em>Footer Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UnitFeatureImpl extends UnitFieldImpl implements UnitFeature {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.UNIT_FEATURE;
	}
	...
	public EList<InlineAction> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentWithInverseEList<InlineAction>(InlineAction.class, this, WebGenInterfacePackage.UNIT_FEATURE__ACTIONS, WebGenInterfacePackage.INLINE_ACTION__USED_BY);
		}
		return actions;
	}
	...
	public void setOnlyDisplayWhenNotEmpty(boolean newOnlyDisplayWhenNotEmpty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__ONLY_DISPLAY_WHEN_NOT_EMPTY, oldOnlyDisplayWhenNotEmpty, onlyDisplayWhenNotEmpty));
	}
	...
	public void setDisplayLabel(String newDisplayLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__DISPLAY_LABEL, oldDisplayLabel, displayLabel));
	}
	...
	public void setRequired(boolean newRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__REQUIRED, oldRequired, required));
	}
	...
	public NotificationChain basicSetForcedValue(Expression newForcedValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__FORCED_VALUE, oldForcedValue, newForcedValue);
	...
	public void setForcedValue(Expression newForcedValue) {
		if (newForcedValue != forcedValue) {
			...
			if (forcedValue != null)
				msgs = ((InternalEObject)forcedValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.UNIT_FEATURE__FORCED_VALUE, null, msgs);
			if (newForcedValue != null)
				msgs = ((InternalEObject)newForcedValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.UNIT_FEATURE__FORCED_VALUE, null, msgs);
			msgs = basicSetForcedValue(newForcedValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__FORCED_VALUE, newForcedValue, newForcedValue));
	}
	...
	public void setNullDisplayValue(String newNullDisplayValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__NULL_DISPLAY_VALUE, oldNullDisplayValue, nullDisplayValue));
	}
	...
	public void setFooter(String newFooter) {
		...
		footer = newFooter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__FOOTER, oldFooter, footer));
	}
	...
	public void setAutofocus(boolean newAutofocus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__AUTOFOCUS, oldAutofocus, autofocus));
	}
	...
	public void setHeaderClass(String newHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__HEADER_CLASS, oldHeaderClass, headerClass));
	}
	...
	public void setInputClass(String newInputClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__INPUT_CLASS, oldInputClass, inputClass));
	}
	...
	public void setDisplayClass(String newDisplayClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__DISPLAY_CLASS, oldDisplayClass, displayClass));
	}
	...
	public void setFooterClass(String newFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_FEATURE__FOOTER_CLASS, oldFooterClass, footerClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenInterfacePackage.UNIT_FEATURE__ACTIONS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WebGenInterfacePackage.UNIT_FEATURE__FORCED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.UNIT_FEATURE__ACTIONS:
				return getActions();
			case WebGenInterfacePackage.UNIT_FEATURE__ONLY_DISPLAY_WHEN_NOT_EMPTY:
				return isOnlyDisplayWhenNotEmpty();
			case WebGenInterfacePackage.UNIT_FEATURE__DISPLAY_LABEL:
				return getDisplayLabel();
			case WebGenInterfacePackage.UNIT_FEATURE__REQUIRED:
				return isRequired();
			case WebGenInterfacePackage.UNIT_FEATURE__FORCED_VALUE:
				return getForcedValue();
			case WebGenInterfacePackage.UNIT_FEATURE__NULL_DISPLAY_VALUE:
				return getNullDisplayValue();
			case WebGenInterfacePackage.UNIT_FEATURE__FOOTER:
				return getFooter();
			case WebGenInterfacePackage.UNIT_FEATURE__AUTOFOCUS:
				return isAutofocus();
			case WebGenInterfacePackage.UNIT_FEATURE__HEADER_CLASS:
				return getHeaderClass();
			case WebGenInterfacePackage.UNIT_FEATURE__INPUT_CLASS:
				return getInputClass();
			case WebGenInterfacePackage.UNIT_FEATURE__DISPLAY_CLASS:
				return getDisplayClass();
			case WebGenInterfacePackage.UNIT_FEATURE__FOOTER_CLASS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == InlineActionContainer.class) {
			switch (derivedFeatureID) {
				case WebGenInterfacePackage.UNIT_FEATURE__ACTIONS: return WebGenInterfacePackage.INLINE_ACTION_CONTAINER__ACTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == InlineActionContainer.class) {
			switch (baseFeatureID) {
				case WebGenInterfacePackage.INLINE_ACTION_CONTAINER__ACTIONS: return WebGenInterfacePackage.UNIT_FEATURE__ACTIONS;
				default: return -1;
			}
		}
