...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.interface_.ChildPathAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenInterfacePackage.Literals.CHILD_PATH_ASSOCIATION__IS_SOURCE_ASSOCIATION,
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenInterfacePackage.Literals.CHILD_PATH_ASSOCIATION__SOURCE_ENTITY,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenInterfacePackage.Literals.CHILD_PATH_ASSOCIATION__TARGET_ENTITY,
				 false,
				 false,
				 false,
				 null,
