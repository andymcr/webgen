...
public class CreateSitemapUnitImpl extends ContentUnitImpl implements CreateSitemapUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.CREATE_SITEMAP_UNIT;
	}
	...
	public void setDeployedURL(String newDeployedURL) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CREATE_SITEMAP_UNIT__DEPLOYED_URL, oldDeployedURL, deployedURL));
	}
	...
	public void setFilename(String newFilename) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CREATE_SITEMAP_UNIT__FILENAME, oldFilename, filename));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CREATE_SITEMAP_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CREATE_SITEMAP_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
