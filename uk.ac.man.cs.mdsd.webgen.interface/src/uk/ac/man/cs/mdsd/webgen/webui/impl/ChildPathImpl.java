...
public abstract class ChildPathImpl extends MinimalEObjectImpl.Container implements ChildPath {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.CHILD_PATH;
	}
	...
	public AssociationReference getPartOf() {
		if (eContainerFeatureID() != WebGenWebUIPackage.CHILD_PATH__PART_OF) return null;
	...
	public NotificationChain basicSetPartOf(AssociationReference newPartOf, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPartOf, WebGenWebUIPackage.CHILD_PATH__PART_OF, msgs);
		return msgs;
	}
	...
	public void setPartOf(AssociationReference newPartOf) {
		if (newPartOf != eInternalContainer() || (eContainerFeatureID() != WebGenWebUIPackage.CHILD_PATH__PART_OF && newPartOf != null)) {
			...
			if (newPartOf != null)
				msgs = ((InternalEObject)newPartOf).eInverseAdd(this, WebGenWebUIPackage.ASSOCIATION_REFERENCE__CHILD_FEATURE, AssociationReference.class, msgs);
			msgs = basicSetPartOf(newPartOf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CHILD_PATH__PART_OF, newPartOf, newPartOf));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.CHILD_PATH__PART_OF:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case WebGenWebUIPackage.CHILD_PATH__PART_OF:
				return eInternalContainer().eInverseRemove(this, WebGenWebUIPackage.ASSOCIATION_REFERENCE__CHILD_FEATURE, AssociationReference.class, msgs);
		}
