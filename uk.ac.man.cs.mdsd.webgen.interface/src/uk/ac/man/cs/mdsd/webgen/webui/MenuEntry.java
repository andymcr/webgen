 ...
 * </ul>
 *
 * @see uk.ac.man.cs.mdsd.webgen.webui.WebGenWebUIPackage#getMenuEntry()
 * @model abstract="true"
 * @generated
 */
public interface MenuEntry extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link uk.ac.man.cs.mdsd.webgen.webui.Menu#getEntries <em>Entries</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setPartOf(Menu)
	 * @see uk.ac.man.cs.mdsd.webgen.webui.WebGenWebUIPackage#getMenuEntry_PartOf()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.webui.MenuEntry#getPartOf <em>Part Of</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.webui.WebGenWebUIPackage#getMenuEntry_RequiresRole()
	 * @model
	 * @generated
	 */
