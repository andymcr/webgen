...
public abstract class PredicateImpl extends MinimalEObjectImpl.Container implements Predicate {
	...
	protected EClass eStaticClass() {
		return WebGenExpressionPackage.Literals.PREDICATE;
	}
	...
	public void setNegated(boolean newNegated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenExpressionPackage.PREDICATE__NEGATED, oldNegated, negated));
	}
