 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ContentUnitImpl#getDisplayedOn <em>Displayed On</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ContentUnitImpl#isCreateDefaultUriElement <em>Create Default Uri Element</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ContentUnitImpl#getRequiresRole <em>Requires Role</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ContentUnitImpl#getPurposeSummary <em>Purpose Summary</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ContentUnitImpl#getUriElement <em>Uri Element</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ContentUnitImpl#getAlternative <em>Alternative</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ContentUnitImpl#isOmitCaption <em>Omit Caption</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ContentUnitImpl#getCaptionClass <em>Caption Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ContentUnitImpl extends NamedDisplayElementImpl implements ContentUnit {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.CONTENT_UNIT;
	}
	...
	public UnitContainer getDisplayedOn() {
		if (eContainerFeatureID() != WebGenInterfacePackage.CONTENT_UNIT__DISPLAYED_ON) return null;
	...
	public NotificationChain basicSetDisplayedOn(UnitContainer newDisplayedOn, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDisplayedOn, WebGenInterfacePackage.CONTENT_UNIT__DISPLAYED_ON, msgs);
		return msgs;
	}
	...
	public void setDisplayedOn(UnitContainer newDisplayedOn) {
		if (newDisplayedOn != eInternalContainer() || (eContainerFeatureID() != WebGenInterfacePackage.CONTENT_UNIT__DISPLAYED_ON && newDisplayedOn != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTENT_UNIT__DISPLAYED_ON, newDisplayedOn, newDisplayedOn));
	}
	...
	public void setCreateDefaultUriElement(boolean newCreateDefaultUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTENT_UNIT__CREATE_DEFAULT_URI_ELEMENT, oldCreateDefaultUriElement, createDefaultUriElement));
	}
	...
	public void setRequiresRole(String newRequiresRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTENT_UNIT__REQUIRES_ROLE, oldRequiresRole, requiresRole));
	}
	...
	public void setPurposeSummary(String newPurposeSummary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTENT_UNIT__PURPOSE_SUMMARY, oldPurposeSummary, purposeSummary));
	}
	...
	public void setUriElement(String newUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTENT_UNIT__URI_ELEMENT, oldUriElement, uriElement));
	}
	...
	public void setAlternative(String newAlternative) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTENT_UNIT__ALTERNATIVE, oldAlternative, alternative));
	}
	...
	public void setOmitCaption(boolean newOmitCaption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTENT_UNIT__OMIT_CAPTION, oldOmitCaption, omitCaption));
	}
	...
	public void setCaptionClass(String newCaptionClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTENT_UNIT__CAPTION_CLASS, oldCaptionClass, captionClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenInterfacePackage.CONTENT_UNIT__DISPLAYED_ON:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WebGenInterfacePackage.CONTENT_UNIT__CREATE_DEFAULT_URI_ELEMENT:
				return isCreateDefaultUriElement();
			case WebGenInterfacePackage.CONTENT_UNIT__REQUIRES_ROLE:
				return getRequiresRole();
			case WebGenInterfacePackage.CONTENT_UNIT__PURPOSE_SUMMARY:
				return getPurposeSummary();
			case WebGenInterfacePackage.CONTENT_UNIT__URI_ELEMENT:
				return getUriElement();
			case WebGenInterfacePackage.CONTENT_UNIT__ALTERNATIVE:
				return getAlternative();
			case WebGenInterfacePackage.CONTENT_UNIT__OMIT_CAPTION:
				return isOmitCaption();
			case WebGenInterfacePackage.CONTENT_UNIT__CAPTION_CLASS:
