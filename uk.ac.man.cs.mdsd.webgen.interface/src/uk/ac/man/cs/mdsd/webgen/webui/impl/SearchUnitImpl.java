 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.SearchUnitImpl#getResultsDestination <em>Results Destination</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.SearchUnitImpl#getStyleClass <em>Style Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SearchUnitImpl extends ControlUnitImpl implements SearchUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.SEARCH_UNIT;
	}
		...
		if (resultsDestination != null && resultsDestination.eIsProxy()) {
			...
			if (resultsDestination != oldResultsDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.SEARCH_UNIT__RESULTS_DESTINATION, oldResultsDestination, resultsDestination));
			}
		}
	...
	public void setResultsDestination(IndexUnit newResultsDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.SEARCH_UNIT__RESULTS_DESTINATION, oldResultsDestination, resultsDestination));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.SEARCH_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.SEARCH_UNIT__RESULTS_DESTINATION:
				if (resolve) return getResultsDestination();
				return basicGetResultsDestination();
			case WebGenWebUIPackage.SEARCH_UNIT__STYLE_CLASS:
