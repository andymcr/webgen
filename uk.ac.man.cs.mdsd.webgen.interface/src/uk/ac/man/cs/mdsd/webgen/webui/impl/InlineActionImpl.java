...
public abstract class InlineActionImpl extends NamedDisplayElementImpl implements InlineAction {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.INLINE_ACTION;
	}
	...
	public InlineActionContainer getUsedBy() {
		if (eContainerFeatureID() != WebGenWebUIPackage.INLINE_ACTION__USED_BY) return null;
	...
	public NotificationChain basicSetUsedBy(InlineActionContainer newUsedBy, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newUsedBy, WebGenWebUIPackage.INLINE_ACTION__USED_BY, msgs);
		return msgs;
	}
	...
	public void setUsedBy(InlineActionContainer newUsedBy) {
		if (newUsedBy != eInternalContainer() || (eContainerFeatureID() != WebGenWebUIPackage.INLINE_ACTION__USED_BY && newUsedBy != null)) {
			...
			if (newUsedBy != null)
				msgs = ((InternalEObject)newUsedBy).eInverseAdd(this, WebGenWebUIPackage.INLINE_ACTION_CONTAINER__ACTIONS, InlineActionContainer.class, msgs);
			msgs = basicSetUsedBy(newUsedBy, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__USED_BY, newUsedBy, newUsedBy));
	}
	...
	public void setDisable(boolean newDisable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__DISABLE, oldDisable, disable));
	}
	...
	public void setRequiresRole(String newRequiresRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__REQUIRES_ROLE, oldRequiresRole, requiresRole));
	}
	...
	public NotificationChain basicSetEnableWhen(Predicate newEnableWhen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__ENABLE_WHEN, oldEnableWhen, newEnableWhen);
	...
	public void setEnableWhen(Predicate newEnableWhen) {
		if (newEnableWhen != enableWhen) {
			NotificationChain msgs = null;
			if (enableWhen != null)
				msgs = ((InternalEObject)enableWhen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.INLINE_ACTION__ENABLE_WHEN, null, msgs);
			if (newEnableWhen != null)
				msgs = ((InternalEObject)newEnableWhen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.INLINE_ACTION__ENABLE_WHEN, null, msgs);
			msgs = basicSetEnableWhen(newEnableWhen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__ENABLE_WHEN, newEnableWhen, newEnableWhen));
	}
	...
	public NotificationChain basicSetDisplayWhen(Predicate newDisplayWhen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__DISPLAY_WHEN, oldDisplayWhen, newDisplayWhen);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDisplayWhen(Predicate newDisplayWhen) {
		if (newDisplayWhen != displayWhen) {
			NotificationChain msgs = null;
			if (displayWhen != null)
				msgs = ((InternalEObject)displayWhen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.INLINE_ACTION__DISPLAY_WHEN, null, msgs);
			if (newDisplayWhen != null)
				msgs = ((InternalEObject)newDisplayWhen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.INLINE_ACTION__DISPLAY_WHEN, null, msgs);
			msgs = basicSetDisplayWhen(newDisplayWhen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__DISPLAY_WHEN, newDisplayWhen, newDisplayWhen));
	}
	...
	public void setHeader(String newHeader) {
		...
		header = newHeader;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__HEADER, oldHeader, header));
	}
	...
	public void setFooter(String newFooter) {
		...
		footer = newFooter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__FOOTER, oldFooter, footer));
	}
	...
	public void setHeaderClass(String newHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__HEADER_CLASS, oldHeaderClass, headerClass));
	}
	...
	public void setFooterClass(String newFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INLINE_ACTION__FOOTER_CLASS, oldFooterClass, footerClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.INLINE_ACTION__USED_BY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WebGenWebUIPackage.INLINE_ACTION__ENABLE_WHEN:
				return basicSetEnableWhen(null, msgs);
			case WebGenWebUIPackage.INLINE_ACTION__DISPLAY_WHEN:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case WebGenWebUIPackage.INLINE_ACTION__USED_BY:
				return eInternalContainer().eInverseRemove(this, WebGenWebUIPackage.INLINE_ACTION_CONTAINER__ACTIONS, InlineActionContainer.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.INLINE_ACTION__USED_BY:
				return getUsedBy();
			case WebGenWebUIPackage.INLINE_ACTION__DISABLE:
				return isDisable();
			case WebGenWebUIPackage.INLINE_ACTION__REQUIRES_ROLE:
				return getRequiresRole();
			case WebGenWebUIPackage.INLINE_ACTION__ENABLE_WHEN:
				return getEnableWhen();
			case WebGenWebUIPackage.INLINE_ACTION__DISPLAY_WHEN:
				return getDisplayWhen();
			case WebGenWebUIPackage.INLINE_ACTION__HEADER:
				return getHeader();
			case WebGenWebUIPackage.INLINE_ACTION__FOOTER:
				return getFooter();
			case WebGenWebUIPackage.INLINE_ACTION__HEADER_CLASS:
				return getHeaderClass();
			case WebGenWebUIPackage.INLINE_ACTION__FOOTER_CLASS:
