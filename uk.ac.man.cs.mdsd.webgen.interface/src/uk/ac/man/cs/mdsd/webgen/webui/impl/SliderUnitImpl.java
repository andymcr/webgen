...
public class SliderUnitImpl extends ImageUnitImpl implements SliderUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.SLIDER_UNIT;
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.SLIDER_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.SLIDER_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
