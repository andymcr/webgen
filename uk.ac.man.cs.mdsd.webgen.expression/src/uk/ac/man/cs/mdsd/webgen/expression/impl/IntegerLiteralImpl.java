...
public class IntegerLiteralImpl extends MinimalEObjectImpl.Container implements IntegerLiteral {
	...
	protected EClass eStaticClass() {
		return WebGenExpressionPackage.Literals.INTEGER_LITERAL;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenExpressionPackage.INTEGER_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenExpressionPackage.INTEGER_LITERAL__VALUE:
				return getValue();
		}
