...
public class MapUnitImpl extends EditUnitImpl implements MapUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.MAP_UNIT;
	}
		...
		if (selectionType != null && selectionType.eIsProxy()) {
			...
			if (selectionType != oldSelectionType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.MAP_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
			}
		}
	...
	public void setSelectionType(EntityOrView newSelectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MAP_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
	}
	...
	public void setReadOnly(boolean newReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MAP_UNIT__READ_ONLY, oldReadOnly, readOnly));
	}
	...
	public void setDefaultZoomLevel(int newDefaultZoomLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MAP_UNIT__DEFAULT_ZOOM_LEVEL, oldDefaultZoomLevel, defaultZoomLevel));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MAP_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public LocationAttribute getLocation() {
		if (location != null && location.eIsProxy()) {
			...
			if (location != oldLocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.MAP_UNIT__LOCATION, oldLocation, location));
			}
		}
		return location;
	}
	...
	public void setLocation(LocationAttribute newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MAP_UNIT__LOCATION, oldLocation, location));
	}
	...
	public Label getPlaceName() {
		if (placeName != null && placeName.eIsProxy()) {
			...
			if (placeName != oldPlaceName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.MAP_UNIT__PLACE_NAME, oldPlaceName, placeName));
			}
		}
		return placeName;
	}
	...
	public void setPlaceName(Label newPlaceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MAP_UNIT__PLACE_NAME, oldPlaceName, placeName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.MAP_UNIT__SELECTION_TYPE:
				if (resolve) return getSelectionType();
				return basicGetSelectionType();
			case WebGenWebUIPackage.MAP_UNIT__READ_ONLY:
				return isReadOnly();
			case WebGenWebUIPackage.MAP_UNIT__DEFAULT_ZOOM_LEVEL:
				return getDefaultZoomLevel();
			case WebGenWebUIPackage.MAP_UNIT__STYLE_CLASS:
				return getStyleClass();
			case WebGenWebUIPackage.MAP_UNIT__LOCATION:
				if (resolve) return getLocation();
				return basicGetLocation();
			case WebGenWebUIPackage.MAP_UNIT__PLACE_NAME:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SelectableUnit.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.MAP_UNIT__SELECTION_TYPE: return WebGenWebUIPackage.SELECTABLE_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SelectableUnit.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.SELECTABLE_UNIT__SELECTION_TYPE: return WebGenWebUIPackage.MAP_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
