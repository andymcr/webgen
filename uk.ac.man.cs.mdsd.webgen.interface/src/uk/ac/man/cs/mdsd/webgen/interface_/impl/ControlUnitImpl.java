 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ControlUnitImpl#getSubmitLabel <em>Submit Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ControlUnitImpl#getCancelDestination <em>Cancel Destination</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ControlUnitImpl#getCancelLabel <em>Cancel Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ControlUnitImpl#getContentClass <em>Content Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ControlUnitImpl extends DynamicUnitImpl implements ControlUnit {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.CONTROL_UNIT;
	}
	...
	public void setSubmitLabel(String newSubmitLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTROL_UNIT__SUBMIT_LABEL, oldSubmitLabel, submitLabel));
	}
	...
	public Page getCancelDestination() {
		if (cancelDestination != null && cancelDestination.eIsProxy()) {
			...
			if (cancelDestination != oldCancelDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.CONTROL_UNIT__CANCEL_DESTINATION, oldCancelDestination, cancelDestination));
			}
		}
	...
	public void setCancelDestination(Page newCancelDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTROL_UNIT__CANCEL_DESTINATION, oldCancelDestination, cancelDestination));
	}
	...
	public void setCancelLabel(String newCancelLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTROL_UNIT__CANCEL_LABEL, oldCancelLabel, cancelLabel));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CONTROL_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.CONTROL_UNIT__SUBMIT_LABEL:
				return getSubmitLabel();
			case WebGenInterfacePackage.CONTROL_UNIT__CANCEL_DESTINATION:
				if (resolve) return getCancelDestination();
				return basicGetCancelDestination();
			case WebGenInterfacePackage.CONTROL_UNIT__CANCEL_LABEL:
				return getCancelLabel();
			case WebGenInterfacePackage.CONTROL_UNIT__CONTENT_CLASS:
