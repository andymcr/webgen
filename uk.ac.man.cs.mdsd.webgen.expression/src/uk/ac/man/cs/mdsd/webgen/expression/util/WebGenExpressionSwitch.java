 ...
 * @generated
 */
public class WebGenExpressionSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WebGenExpressionPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebGenExpressionPackage.LITERAL: {
			...
			case WebGenExpressionPackage.NULL_LITERAL: {
			...
			case WebGenExpressionPackage.BOOLEAN_LITERAL: {
			...
			case WebGenExpressionPackage.INTEGER_LITERAL: {
			...
			case WebGenExpressionPackage.STRING_LITERAL: {
			...
			case WebGenExpressionPackage.TIME_LITERAL: {
			...
			case WebGenExpressionPackage.CURRENT_TIME: {
			...
			case WebGenExpressionPackage.FUNCTION: {
			...
			case WebGenExpressionPackage.PATH: {
			...
			case WebGenExpressionPackage.PREDICATE: {
			...
			case WebGenExpressionPackage.PREDICATE_BOOLEAN_OPERATOR: {
			...
			case WebGenExpressionPackage.PREDICATE_EQUALITY_OPERATOR: {
			...
			case WebGenExpressionPackage.PREDICATE_COMPARISON_OPERATOR: {
			...
			case WebGenExpressionPackage.PREDICATE_IS_OPERATOR: {
			...
			case WebGenExpressionPackage.PREDICATE_LIKE_OPERATOR: {
			...
			case WebGenExpressionPackage.PREDICATE_IS_EMPTY: {
			...
			case WebGenExpressionPackage.PREDICATE_IS_NULL: {
