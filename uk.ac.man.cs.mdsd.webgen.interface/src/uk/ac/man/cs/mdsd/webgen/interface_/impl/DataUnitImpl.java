 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.DataUnitImpl#getDefaultSelection <em>Default Selection</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.DataUnitImpl#getTitle <em>Title</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DataUnitImpl extends DynamicUnitImpl implements DataUnit {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.DATA_UNIT;
	}
		...
		if (defaultSelection != null && defaultSelection.eIsProxy()) {
			...
			if (defaultSelection != oldDefaultSelection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.DATA_UNIT__DEFAULT_SELECTION, oldDefaultSelection, defaultSelection));
			}
		}
	...
	public void setDefaultSelection(Selection newDefaultSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.DATA_UNIT__DEFAULT_SELECTION, oldDefaultSelection, defaultSelection));
	}
	...
	public Label getTitle() {
		if (title != null && title.eIsProxy()) {
			...
			if (title != oldTitle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.DATA_UNIT__TITLE, oldTitle, title));
			}
		}
		return title;
	}
	...
	public void setTitle(Label newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.DATA_UNIT__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.DATA_UNIT__DEFAULT_SELECTION:
				if (resolve) return getDefaultSelection();
				return basicGetDefaultSelection();
			case WebGenInterfacePackage.DATA_UNIT__TITLE:
