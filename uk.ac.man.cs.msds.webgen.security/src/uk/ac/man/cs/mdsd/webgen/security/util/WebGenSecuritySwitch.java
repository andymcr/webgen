 ...
 * @generated
 */
public class WebGenSecuritySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WebGenSecurityPackage.CAS_AUTHENTICATION: {
			...
			case WebGenSecurityPackage.AUTHORISATION: {
