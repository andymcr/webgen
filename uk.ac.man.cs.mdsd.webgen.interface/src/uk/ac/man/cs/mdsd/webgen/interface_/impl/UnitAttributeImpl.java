 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitAttributeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitAttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitAttributeImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitAttributeImpl#isObfuscateFormFields <em>Obfuscate Form Fields</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitAttributeImpl#getPlaceholder <em>Placeholder</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitAttributeImpl#getValidationPattern <em>Validation Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnitAttributeImpl extends UnitFeatureImpl implements UnitAttribute {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate NAME__ESETTING_DELEGATE = ((EStructuralFeature.Internal)WebGenInterfacePackage.Literals.UNIT_ATTRIBUTE__NAME).getSettingDelegate();
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.UNIT_ATTRIBUTE;
	}
		...
		if (attribute != null && attribute.eIsProxy()) {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.UNIT_ATTRIBUTE__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public void setAttribute(Attribute newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_ATTRIBUTE__ATTRIBUTE, oldAttribute, attribute));
	}
	...
	public NotificationChain basicSetDefaultValue(Expression newDefaultValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_ATTRIBUTE__DEFAULT_VALUE, oldDefaultValue, newDefaultValue);
	...
	public void setDefaultValue(Expression newDefaultValue) {
		if (newDefaultValue != defaultValue) {
			...
			if (defaultValue != null)
				msgs = ((InternalEObject)defaultValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.UNIT_ATTRIBUTE__DEFAULT_VALUE, null, msgs);
			if (newDefaultValue != null)
				msgs = ((InternalEObject)newDefaultValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.UNIT_ATTRIBUTE__DEFAULT_VALUE, null, msgs);
			msgs = basicSetDefaultValue(newDefaultValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_ATTRIBUTE__DEFAULT_VALUE, newDefaultValue, newDefaultValue));
	}
	...
	public void setObfuscateFormFields(boolean newObfuscateFormFields) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_ATTRIBUTE__OBFUSCATE_FORM_FIELDS, oldObfuscateFormFields, obfuscateFormFields));
	}
	...
	public void setPlaceholder(String newPlaceholder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_ATTRIBUTE__PLACEHOLDER, oldPlaceholder, placeholder));
	}
	...
	public void setValidationPattern(String newValidationPattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_ATTRIBUTE__VALIDATION_PATTERN, oldValidationPattern, validationPattern));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.UNIT_ATTRIBUTE__ATTRIBUTE:
