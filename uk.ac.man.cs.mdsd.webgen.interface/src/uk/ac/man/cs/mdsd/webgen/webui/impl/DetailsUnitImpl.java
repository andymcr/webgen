...
public class DetailsUnitImpl extends DataUnitImpl implements DetailsUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.DETAILS_UNIT;
	}
		...
		if (contentType != null && contentType.eIsProxy()) {
			...
			if (contentType != oldContentType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.DETAILS_UNIT__CONTENT_TYPE, oldContentType, contentType));
			}
		}
		return contentType;
	}
	...
	public void setContentType(EntityOrView newContentType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DETAILS_UNIT__CONTENT_TYPE, oldContentType, contentType));
	}
	...
	public EntityOrView getSelectionType() {
		if (selectionType != null && selectionType.eIsProxy()) {
			...
			if (selectionType != oldSelectionType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.DETAILS_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
			}
		}
	...
	public void setSelectionType(EntityOrView newSelectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DETAILS_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
	}
	...
	public void setOnlyDisplayWhenNotEmpty(boolean newOnlyDisplayWhenNotEmpty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DETAILS_UNIT__ONLY_DISPLAY_WHEN_NOT_EMPTY, oldOnlyDisplayWhenNotEmpty, onlyDisplayWhenNotEmpty));
	}
	...
	public void setOmitFieldLabels(boolean newOmitFieldLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DETAILS_UNIT__OMIT_FIELD_LABELS, oldOmitFieldLabels, omitFieldLabels));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DETAILS_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DETAILS_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.DETAILS_UNIT__CONTENT_TYPE:
				if (resolve) return getContentType();
				return basicGetContentType();
			case WebGenWebUIPackage.DETAILS_UNIT__SELECTION_TYPE:
				if (resolve) return getSelectionType();
				return basicGetSelectionType();
			case WebGenWebUIPackage.DETAILS_UNIT__ONLY_DISPLAY_WHEN_NOT_EMPTY:
				return isOnlyDisplayWhenNotEmpty();
			case WebGenWebUIPackage.DETAILS_UNIT__OMIT_FIELD_LABELS:
				return isOmitFieldLabels();
			case WebGenWebUIPackage.DETAILS_UNIT__STYLE_CLASS:
				return getStyleClass();
			case WebGenWebUIPackage.DETAILS_UNIT__CONTENT_CLASS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SingletonUnit.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.DETAILS_UNIT__CONTENT_TYPE: return WebGenWebUIPackage.SINGLETON_UNIT__CONTENT_TYPE;
				default: return -1;
			}
		}
		if (baseClass == SelectableUnit.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.DETAILS_UNIT__SELECTION_TYPE: return WebGenWebUIPackage.SELECTABLE_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SingletonUnit.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.SINGLETON_UNIT__CONTENT_TYPE: return WebGenWebUIPackage.DETAILS_UNIT__CONTENT_TYPE;
				default: return -1;
			}
		}
		if (baseClass == SelectableUnit.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.SELECTABLE_UNIT__SELECTION_TYPE: return WebGenWebUIPackage.DETAILS_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
