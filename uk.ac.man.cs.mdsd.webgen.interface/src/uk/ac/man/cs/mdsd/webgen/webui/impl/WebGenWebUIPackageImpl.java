...
import uk.ac.man.cs.mdsd.webgen.webui.ModelReference;
...
import uk.ac.man.cs.mdsd.webgen.webui.RouteParameterReference;
...
import uk.ac.man.cs.mdsd.webgen.webui.util.WebGenWebUIValidator;
 ...
 * @generated
 */
public class WebGenWebUIPackageImpl extends EPackageImpl implements WebGenWebUIPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.webui.WebGenWebUIPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private WebGenWebUIPackageImpl() {
		super(eNS_URI, WebGenWebUIFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link WebGenWebUIPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static WebGenWebUIPackage init() {
		if (isInited) return (WebGenWebUIPackage)EPackage.Registry.INSTANCE.getEPackage(WebGenWebUIPackage.eNS_URI);

		// Obtain or create and register package
		WebGenWebUIPackageImpl theWebGenWebUIPackage = (WebGenWebUIPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof WebGenWebUIPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new WebGenWebUIPackageImpl());
		...
		theWebGenWebUIPackage.createPackageContents();

		// Initialize created meta-data
		theWebGenWebUIPackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(theWebGenWebUIPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return WebGenWebUIValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theWebGenWebUIPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(WebGenWebUIPackage.eNS_URI, theWebGenWebUIPackage);
		return theWebGenWebUIPackage;
	}
	 ...
	 * @generated
	 */
	public WebGenWebUIFactory getWebGenWebUIFactory() {
		return (WebGenWebUIFactory)getEFactoryInstance();
	}
