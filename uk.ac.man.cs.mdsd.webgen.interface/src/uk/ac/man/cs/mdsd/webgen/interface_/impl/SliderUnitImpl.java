 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.SliderUnitImpl#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.SliderUnitImpl#getContentClass <em>Content Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SliderUnitImpl extends ImageUnitImpl implements SliderUnit {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.SLIDER_UNIT;
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.SLIDER_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.SLIDER_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.SLIDER_UNIT__STYLE_CLASS:
				return getStyleClass();
			case WebGenInterfacePackage.SLIDER_UNIT__CONTENT_CLASS:
