 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.CreateSitemapUnitImpl#getDeployedURL <em>Deployed URL</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.CreateSitemapUnitImpl#getFilename <em>Filename</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.CreateSitemapUnitImpl#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.CreateSitemapUnitImpl#getContentClass <em>Content Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CreateSitemapUnitImpl extends ContentUnitImpl implements CreateSitemapUnit {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.CREATE_SITEMAP_UNIT;
	}
	...
	public void setDeployedURL(String newDeployedURL) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CREATE_SITEMAP_UNIT__DEPLOYED_URL, oldDeployedURL, deployedURL));
	}
	...
	public void setFilename(String newFilename) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CREATE_SITEMAP_UNIT__FILENAME, oldFilename, filename));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CREATE_SITEMAP_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CREATE_SITEMAP_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
