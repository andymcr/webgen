...
public abstract class DataUnitImpl extends DynamicUnitImpl implements DataUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.DATA_UNIT;
	}
		...
		if (defaultSelection != null && defaultSelection.eIsProxy()) {
			...
			if (defaultSelection != oldDefaultSelection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.DATA_UNIT__DEFAULT_SELECTION, oldDefaultSelection, defaultSelection));
			}
		}
	...
	public void setDefaultSelection(Selection newDefaultSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DATA_UNIT__DEFAULT_SELECTION, oldDefaultSelection, defaultSelection));
	}
	...
	public Label getTitle() {
		if (title != null && title.eIsProxy()) {
			...
			if (title != oldTitle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.DATA_UNIT__TITLE, oldTitle, title));
			}
		}
		return title;
	}
	...
	public void setTitle(Label newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DATA_UNIT__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.DATA_UNIT__DEFAULT_SELECTION:
				if (resolve) return getDefaultSelection();
				return basicGetDefaultSelection();
			case WebGenWebUIPackage.DATA_UNIT__TITLE:
