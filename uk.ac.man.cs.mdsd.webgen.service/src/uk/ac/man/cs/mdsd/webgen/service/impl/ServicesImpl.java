 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.service.impl.ServicesImpl#getServices <em>Services</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServicesImpl extends MinimalEObjectImpl.Container implements Services {
	...
	protected EClass eStaticClass() {
		return WebGenServicePackage.Literals.SERVICES;
	}
	...
	public EList<Service> getServices() {
		if (services == null) {
			services = new EObjectContainmentEList<Service>(Service.class, this, WebGenServicePackage.SERVICES__SERVICES);
		}
		return services;
	}
