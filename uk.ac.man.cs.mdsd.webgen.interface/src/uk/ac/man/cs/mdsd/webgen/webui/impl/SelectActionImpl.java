...
public class SelectActionImpl extends InlineActionImpl implements SelectAction {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.SELECT_ACTION;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.SELECT_ACTION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(SelectableUnit newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.SELECT_ACTION__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.SELECT_ACTION__TARGET:
