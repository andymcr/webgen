...
public class PersistenceFactoryImpl extends EFactoryImpl implements PersistenceFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PersistencePackage.DATA_TYPE: return createDataType();
			case PersistencePackage.ENUMERATION_TYPE: return createEnumerationType();
			case PersistencePackage.ENUMERATION_LITERAL: return createEnumerationLiteral();
