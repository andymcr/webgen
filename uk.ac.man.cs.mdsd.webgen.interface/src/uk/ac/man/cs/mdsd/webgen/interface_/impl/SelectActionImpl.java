 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.SelectActionImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelectActionImpl extends InlineActionImpl implements SelectAction {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.SELECT_ACTION;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.SELECT_ACTION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(SelectableUnit newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.SELECT_ACTION__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.SELECT_ACTION__TARGET:
