 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getEntities <em>Entities</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getDisplayFields <em>Display Fields</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getSupportActions <em>Support Actions</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getHeader <em>Header</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getFooter <em>Footer</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getHeaderClass <em>Header Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getControlClass <em>Control Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getFooterClass <em>Footer Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getErrorClass <em>Error Class</em>}</li>
 * </ul>
 *
 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getDynamicUnit()
 * @model abstract="true"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='featuresMustBeFromContentType'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL featuresMustBeFromContentType='let entities : OrderedSet(EntityOrView)\r\n\t= if self.oclIsKindOf(SingletonUnit) then\r\n\t\t\tOrderedSet{self.oclAsType(SingletonUnit).contentType}\r\n\t\telse if self.oclIsKindOf(CollectionUnit) then\r\n\t\t\tself.oclAsType(CollectionUnit).contentType\r\n\t\telse\r\n\t\t\tself.entities\r\n\t\tendif endif\r\n\tin let eovFeatures : Collection(Feature)\r\n\t\t= entities->collect(eov | eov.allFeatures)\r\n\t\tin displayFields\r\n\t\t\t->select(f | f.oclIsKindOf(UnitFeature)).oclAsType(UnitFeature)\r\n\t\t\t->select(f | \r\n\t\t\t\tif f.oclIsTypeOf(UnitElement) then\r\n\t\t\t\t\tnot f.oclAsType(UnitElement).attribute.oclIsUndefined()\r\n\t\t\t\telse\r\n\t\t\t\t\tnot f.oclAsType(UnitAssociation).association.oclIsUndefined()\r\n\t\t\t\tendif)\r\n\t\t\t->forAll(f | \r\n\t\t\t\tif f.oclIsTypeOf(UnitElement) then\r\n\t\t\t\t\teovFeatures->includes(f.oclAsType(UnitElement).attribute)\r\n\t\t\t\telse\r\n\t\t\t\t\teovFeatures->includes(f.oclAsType(UnitAssociation).association)\r\n\t\t\t\tendif)'"
 * @generated
 */
public interface DynamicUnit extends ContentUnit {
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getDynamicUnit_Entities()
	 * @model
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link uk.ac.man.cs.mdsd.webgen.interface_.UnitField}.
	 * It is bidirectional and its opposite is '{@link uk.ac.man.cs.mdsd.webgen.interface_.UnitField#getDisplayedOn <em>Displayed On</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getDynamicUnit_DisplayFields()
	 ...
	 * The list contents are of type {@link uk.ac.man.cs.mdsd.webgen.interface_.UnitSupportAction}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getDynamicUnit_SupportActions()
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getDynamicUnit_Header()
	 * @model
	 * @generated
	 */
	String getHeader();
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getHeader <em>Header</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getDynamicUnit_Footer()
	 * @model
	 * @generated
	 */
	String getFooter();
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getFooter <em>Footer</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getDynamicUnit_HeaderClass()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getHeaderClass <em>Header Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getDynamicUnit_ControlClass()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getControlClass <em>Control Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getDynamicUnit_FooterClass()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getFooterClass <em>Footer Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getDynamicUnit_ErrorClass()
	 * @model default="error"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.DynamicUnit#getErrorClass <em>Error Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
