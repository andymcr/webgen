...
public abstract class InterfaceFieldImpl extends NamedDisplayElementImpl implements InterfaceField {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.INTERFACE_FIELD;
	}
	...
	public DynamicUnit getDisplayedOn() {
		if (eContainerFeatureID() != WebGenWebUIPackage.INTERFACE_FIELD__DISPLAYED_ON) return null;
	...
	public NotificationChain basicSetDisplayedOn(DynamicUnit newDisplayedOn, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDisplayedOn, WebGenWebUIPackage.INTERFACE_FIELD__DISPLAYED_ON, msgs);
		return msgs;
	}
	...
	public void setDisplayedOn(DynamicUnit newDisplayedOn) {
		if (newDisplayedOn != eInternalContainer() || (eContainerFeatureID() != WebGenWebUIPackage.INTERFACE_FIELD__DISPLAYED_ON && newDisplayedOn != null)) {
			...
			if (newDisplayedOn != null)
				msgs = ((InternalEObject)newDisplayedOn).eInverseAdd(this, WebGenWebUIPackage.DYNAMIC_UNIT__DISPLAY_FIELDS, DynamicUnit.class, msgs);
			msgs = basicSetDisplayedOn(newDisplayedOn, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__DISPLAYED_ON, newDisplayedOn, newDisplayedOn));
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__TITLE, oldTitle, title));
	}
	...
	public void setCollectionDisplayOption(CollectionDisplayOptions newCollectionDisplayOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_DISPLAY_OPTION, oldCollectionDisplayOption, collectionDisplayOption));
	}
	...
	public void setCollectionAllowAdd(boolean newCollectionAllowAdd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_ALLOW_ADD, oldCollectionAllowAdd, collectionAllowAdd));
	}
	...
	public void setCollectionAllowRemove(boolean newCollectionAllowRemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_ALLOW_REMOVE, oldCollectionAllowRemove, collectionAllowRemove));
	}
	...
	public void setMaximumDisplaySize(int newMaximumDisplaySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__MAXIMUM_DISPLAY_SIZE, oldMaximumDisplaySize, maximumDisplaySize));
	}
	...
	public void setDateFormat(String newDateFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__DATE_FORMAT, oldDateFormat, dateFormat));
	}
	...
	public void setRequired(boolean newRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__REQUIRED, oldRequired, required));
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public UnitField getMustMatch() {
		if (mustMatch != null && mustMatch.eIsProxy()) {
			...
			if (mustMatch != oldMustMatch) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.INTERFACE_FIELD__MUST_MATCH, oldMustMatch, mustMatch));
			}
		}
		return mustMatch;
	}
	...
	public void setMustMatch(UnitField newMustMatch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__MUST_MATCH, oldMustMatch, mustMatch));
	}
	...
	public void setInputClass(String newInputClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__INPUT_CLASS, oldInputClass, inputClass));
	}
	...
	public void setPlaceholder(String newPlaceholder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__PLACEHOLDER, oldPlaceholder, placeholder));
	}
	...
	public void setValidationPattern(String newValidationPattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INTERFACE_FIELD__VALIDATION_PATTERN, oldValidationPattern, validationPattern));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.INTERFACE_FIELD__DISPLAYED_ON:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case WebGenWebUIPackage.INTERFACE_FIELD__DISPLAYED_ON:
				return eInternalContainer().eInverseRemove(this, WebGenWebUIPackage.DYNAMIC_UNIT__DISPLAY_FIELDS, DynamicUnit.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WebGenWebUIPackage.INTERFACE_FIELD__TITLE:
				return getTitle();
			case WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_DISPLAY_OPTION:
				return getCollectionDisplayOption();
			case WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_ALLOW_ADD:
				return isCollectionAllowAdd();
			case WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_ALLOW_REMOVE:
				return isCollectionAllowRemove();
			case WebGenWebUIPackage.INTERFACE_FIELD__MAXIMUM_DISPLAY_SIZE:
				return getMaximumDisplaySize();
			case WebGenWebUIPackage.INTERFACE_FIELD__DATE_FORMAT:
				return getDateFormat();
			case WebGenWebUIPackage.INTERFACE_FIELD__REQUIRED:
				return isRequired();
			case WebGenWebUIPackage.INTERFACE_FIELD__DEFAULT_VALUE:
				return getDefaultValue();
			case WebGenWebUIPackage.INTERFACE_FIELD__MUST_MATCH:
				if (resolve) return getMustMatch();
				return basicGetMustMatch();
			case WebGenWebUIPackage.INTERFACE_FIELD__INPUT_CLASS:
				return getInputClass();
			case WebGenWebUIPackage.INTERFACE_FIELD__PLACEHOLDER:
				return getPlaceholder();
			case WebGenWebUIPackage.INTERFACE_FIELD__VALIDATION_PATTERN:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == UnitField.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.INTERFACE_FIELD__DISPLAYED_ON: return WebGenWebUIPackage.UNIT_FIELD__DISPLAYED_ON;
				case WebGenWebUIPackage.INTERFACE_FIELD__TITLE: return WebGenWebUIPackage.UNIT_FIELD__TITLE;
				case WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_DISPLAY_OPTION: return WebGenWebUIPackage.UNIT_FIELD__COLLECTION_DISPLAY_OPTION;
				case WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_ALLOW_ADD: return WebGenWebUIPackage.UNIT_FIELD__COLLECTION_ALLOW_ADD;
				case WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_ALLOW_REMOVE: return WebGenWebUIPackage.UNIT_FIELD__COLLECTION_ALLOW_REMOVE;
				case WebGenWebUIPackage.INTERFACE_FIELD__MAXIMUM_DISPLAY_SIZE: return WebGenWebUIPackage.UNIT_FIELD__MAXIMUM_DISPLAY_SIZE;
				case WebGenWebUIPackage.INTERFACE_FIELD__DATE_FORMAT: return WebGenWebUIPackage.UNIT_FIELD__DATE_FORMAT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == UnitField.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.UNIT_FIELD__DISPLAYED_ON: return WebGenWebUIPackage.INTERFACE_FIELD__DISPLAYED_ON;
				case WebGenWebUIPackage.UNIT_FIELD__TITLE: return WebGenWebUIPackage.INTERFACE_FIELD__TITLE;
				case WebGenWebUIPackage.UNIT_FIELD__COLLECTION_DISPLAY_OPTION: return WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_DISPLAY_OPTION;
				case WebGenWebUIPackage.UNIT_FIELD__COLLECTION_ALLOW_ADD: return WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_ALLOW_ADD;
				case WebGenWebUIPackage.UNIT_FIELD__COLLECTION_ALLOW_REMOVE: return WebGenWebUIPackage.INTERFACE_FIELD__COLLECTION_ALLOW_REMOVE;
				case WebGenWebUIPackage.UNIT_FIELD__MAXIMUM_DISPLAY_SIZE: return WebGenWebUIPackage.INTERFACE_FIELD__MAXIMUM_DISPLAY_SIZE;
				case WebGenWebUIPackage.UNIT_FIELD__DATE_FORMAT: return WebGenWebUIPackage.INTERFACE_FIELD__DATE_FORMAT;
				default: return -1;
			}
		}
