 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.DataTypeFieldImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.DataTypeFieldImpl#isObfuscateFormFields <em>Obfuscate Form Fields</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.DataTypeFieldImpl#isEncrypt <em>Encrypt</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.DataTypeFieldImpl#getInterfaceType <em>Interface Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataTypeFieldImpl extends InterfaceFieldImpl implements DataTypeField {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.DATA_TYPE_FIELD;
	}
		...
		if (dataType != null && dataType.eIsProxy()) {
			...
			if (dataType != oldDataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.DATA_TYPE_FIELD__DATA_TYPE, oldDataType, dataType));
			}
		}
		return dataType;
	}
	...
	public void setDataType(DataType newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.DATA_TYPE_FIELD__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setObfuscateFormFields(boolean newObfuscateFormFields) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.DATA_TYPE_FIELD__OBFUSCATE_FORM_FIELDS, oldObfuscateFormFields, obfuscateFormFields));
	}
	...
	public void setEncrypt(boolean newEncrypt) {
		...
		encrypt = newEncrypt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.DATA_TYPE_FIELD__ENCRYPT, oldEncrypt, encrypt));
	}
	...
	public void setInterfaceType(String newInterfaceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.DATA_TYPE_FIELD__INTERFACE_TYPE, oldInterfaceType, interfaceType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.DATA_TYPE_FIELD__DATA_TYPE:
				if (resolve) return getDataType();
				return basicGetDataType();
			case WebGenInterfacePackage.DATA_TYPE_FIELD__OBFUSCATE_FORM_FIELDS:
				return isObfuscateFormFields();
			case WebGenInterfacePackage.DATA_TYPE_FIELD__ENCRYPT:
				return isEncrypt();
			case WebGenInterfacePackage.DATA_TYPE_FIELD__INTERFACE_TYPE:
