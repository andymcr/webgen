 ...
 * </ul>
 *
 * @see uk.ac.man.cs.mdsd.webgen.image.WebGenImagePackage#getThumbnailFilter()
 * @model
 * @generated
 */
public interface ThumbnailFilter extends ImageFilter {
	 ...
	 * @see #setWidth(int)
	 * @see uk.ac.man.cs.mdsd.webgen.image.WebGenImagePackage#getThumbnailFilter_Width()
	 * @model default="-1"
	 * @generated
	 */
	int getWidth();
	 ...
	 * @see #setHeight(int)
	 * @see uk.ac.man.cs.mdsd.webgen.image.WebGenImagePackage#getThumbnailFilter_Height()
	 * @model default="-1"
	 * @generated
	 */
	int getHeight();
