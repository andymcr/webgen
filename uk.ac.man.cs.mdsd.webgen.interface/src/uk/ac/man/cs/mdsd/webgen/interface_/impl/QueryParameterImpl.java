 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.QueryParameterImpl#getFormal <em>Formal</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.QueryParameterImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QueryParameterImpl extends MinimalEObjectImpl.Container implements QueryParameter {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.QUERY_PARAMETER;
	}
		...
		if (formal != null && formal.eIsProxy()) {
			...
			if (formal != oldFormal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.QUERY_PARAMETER__FORMAL, oldFormal, formal));
			}
		}
		return formal;
	}
	...
	public void setFormal(FilterParameter newFormal) {
		...
		formal = newFormal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.QUERY_PARAMETER__FORMAL, oldFormal, formal));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.QUERY_PARAMETER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.QUERY_PARAMETER__FORMAL:
				if (resolve) return getFormal();
				return basicGetFormal();
			case WebGenInterfacePackage.QUERY_PARAMETER__VALUE:
				return getValue();
		}
