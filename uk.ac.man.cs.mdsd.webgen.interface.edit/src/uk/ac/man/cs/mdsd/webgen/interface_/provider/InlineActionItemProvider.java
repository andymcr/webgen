...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.interface_.InlineAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InlineActionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenInterfacePackage.Literals.INLINE_ACTION__DISABLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenInterfacePackage.Literals.INLINE_ACTION__REQUIRES_ROLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenInterfacePackage.Literals.INLINE_ACTION__HEADER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenInterfacePackage.Literals.INLINE_ACTION__FOOTER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenInterfacePackage.Literals.INLINE_ACTION__HEADER_CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenInterfacePackage.Literals.INLINE_ACTION__FOOTER_CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebGenInterfacePackage.Literals.INLINE_ACTION__ENABLE_WHEN);
			childrenFeatures.add(WebGenInterfacePackage.Literals.INLINE_ACTION__DISPLAY_WHEN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebGenInterfacePackage.Literals.INLINE_ACTION__ENABLE_WHEN,
		...
		newChildDescriptors.add
			(createChildParameter
				(WebGenInterfacePackage.Literals.INLINE_ACTION__DISPLAY_WHEN,
				 WebGenExpressionFactory.eINSTANCE.createPredicateBooleanOperator()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == WebGenInterfacePackage.Literals.INLINE_ACTION__ENABLE_WHEN ||
			childFeature == WebGenInterfacePackage.Literals.INLINE_ACTION__DISPLAY_WHEN;
