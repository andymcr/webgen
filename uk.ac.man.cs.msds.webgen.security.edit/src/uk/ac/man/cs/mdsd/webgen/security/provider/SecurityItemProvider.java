...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.security.Security} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SecurityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Security_user_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Security_user_feature", "_UI_Security_type"),
				 WebGenSecurityPackage.Literals.SECURITY__USER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUserKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Security_userKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Security_userKey_feature", "_UI_Security_type"),
				 WebGenSecurityPackage.Literals.SECURITY__USER_KEY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebGenSecurityPackage.Literals.SECURITY__AUTHENTICATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebGenSecurityPackage.Literals.SECURITY__AUTHENTICATION,
				 WebGenSecurityFactory.eINSTANCE.createLocalAuthenticationSystem()));

		newChildDescriptors.add
			(createChildParameter
				(WebGenSecurityPackage.Literals.SECURITY__AUTHENTICATION,
				 WebGenSecurityFactory.eINSTANCE.createCasAuthentication()));
	}
