 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.CreateUpdateUnitImpl#getSelectionType <em>Selection Type</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.CreateUpdateUnitImpl#getCreateUriElement <em>Create Uri Element</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.CreateUpdateUnitImpl#getClearLabel <em>Clear Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.CreateUpdateUnitImpl#getStyleClass <em>Style Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CreateUpdateUnitImpl extends EditUnitImpl implements CreateUpdateUnit {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.CREATE_UPDATE_UNIT;
	}
		...
		if (selectionType != null && selectionType.eIsProxy()) {
			...
			if (selectionType != oldSelectionType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.CREATE_UPDATE_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
			}
		}
	...
	public void setSelectionType(EntityOrView newSelectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CREATE_UPDATE_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
	}
	...
	public void setCreateUriElement(String newCreateUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CREATE_UPDATE_UNIT__CREATE_URI_ELEMENT, oldCreateUriElement, createUriElement));
	}
	...
	public void setClearLabel(String newClearLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CREATE_UPDATE_UNIT__CLEAR_LABEL, oldClearLabel, clearLabel));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.CREATE_UPDATE_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.CREATE_UPDATE_UNIT__SELECTION_TYPE:
				if (resolve) return getSelectionType();
				return basicGetSelectionType();
			case WebGenInterfacePackage.CREATE_UPDATE_UNIT__CREATE_URI_ELEMENT:
				return getCreateUriElement();
			case WebGenInterfacePackage.CREATE_UPDATE_UNIT__CLEAR_LABEL:
				return getClearLabel();
			case WebGenInterfacePackage.CREATE_UPDATE_UNIT__STYLE_CLASS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SelectableUnit.class) {
			switch (derivedFeatureID) {
				case WebGenInterfacePackage.CREATE_UPDATE_UNIT__SELECTION_TYPE: return WebGenInterfacePackage.SELECTABLE_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SelectableUnit.class) {
			switch (baseFeatureID) {
				case WebGenInterfacePackage.SELECTABLE_UNIT__SELECTION_TYPE: return WebGenInterfacePackage.CREATE_UPDATE_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
