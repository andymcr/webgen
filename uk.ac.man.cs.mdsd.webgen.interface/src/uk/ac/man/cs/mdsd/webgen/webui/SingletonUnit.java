 ...
 * </ul>
 *
 * @see uk.ac.man.cs.mdsd.webgen.webui.WebGenWebUIPackage#getSingletonUnit()
...
public interface SingletonUnit extends EObject {
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.webui.WebGenWebUIPackage#getSingletonUnit_ContentType()
	 * @model required="true"
	 * @generated
	 */
