 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.image.impl.ImageManipulationImpl#getJpegQuality <em>Jpeg Quality</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.image.impl.ImageManipulationImpl#getFilters <em>Filters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImageManipulationImpl extends NamedElementImpl implements ImageManipulation {
	...
	protected EClass eStaticClass() {
		return WebGenImagePackage.Literals.IMAGE_MANIPULATION;
	}
	...
	public void setJpegQuality(int newJpegQuality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenImagePackage.IMAGE_MANIPULATION__JPEG_QUALITY, oldJpegQuality, jpegQuality));
	}
	...
	public EList<ImageFilter> getFilters() {
		if (filters == null) {
			filters = new EObjectContainmentEList<ImageFilter>(ImageFilter.class, this, WebGenImagePackage.IMAGE_MANIPULATION__FILTERS);
		}
		return filters;
	}
