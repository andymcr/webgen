 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageIndexUnitImpl#getActions <em>Actions</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageIndexUnitImpl#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageIndexUnitImpl#getContentClass <em>Content Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImageIndexUnitImpl extends ImageUnitImpl implements ImageIndexUnit {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.IMAGE_INDEX_UNIT;
	}
	...
	public EList<InlineAction> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentWithInverseEList<InlineAction>(InlineAction.class, this, WebGenInterfacePackage.IMAGE_INDEX_UNIT__ACTIONS, WebGenInterfacePackage.INLINE_ACTION__USED_BY);
		}
		return actions;
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_INDEX_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_INDEX_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenInterfacePackage.IMAGE_INDEX_UNIT__ACTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.IMAGE_INDEX_UNIT__ACTIONS:
				return getActions();
			case WebGenInterfacePackage.IMAGE_INDEX_UNIT__STYLE_CLASS:
				return getStyleClass();
			case WebGenInterfacePackage.IMAGE_INDEX_UNIT__CONTENT_CLASS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == InlineActionContainer.class) {
			switch (derivedFeatureID) {
				case WebGenInterfacePackage.IMAGE_INDEX_UNIT__ACTIONS: return WebGenInterfacePackage.INLINE_ACTION_CONTAINER__ACTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == InlineActionContainer.class) {
			switch (baseFeatureID) {
				case WebGenInterfacePackage.INLINE_ACTION_CONTAINER__ACTIONS: return WebGenInterfacePackage.IMAGE_INDEX_UNIT__ACTIONS;
				default: return -1;
			}
		}
