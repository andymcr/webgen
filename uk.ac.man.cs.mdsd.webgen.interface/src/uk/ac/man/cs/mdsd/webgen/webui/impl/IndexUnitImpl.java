...
public class IndexUnitImpl extends DataUnitImpl implements IndexUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.INDEX_UNIT;
	}
		...
		if (selectionType != null && selectionType.eIsProxy()) {
			...
			if (selectionType != oldSelectionType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.INDEX_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
			}
		}
	...
	public void setSelectionType(EntityOrView newSelectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
	}
	...
	public EList<EntityOrView> getContentType() {
		if (contentType == null) {
			contentType = new EObjectResolvingEList<EntityOrView>(EntityOrView.class, this, WebGenWebUIPackage.INDEX_UNIT__CONTENT_TYPE);
		}
		return contentType;
	}
	...
	public Association getContainingFeature() {
		if (containingFeature != null && containingFeature.eIsProxy()) {
			...
			if (containingFeature != oldContainingFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.INDEX_UNIT__CONTAINING_FEATURE, oldContainingFeature, containingFeature));
			}
		}
	...
	public void setContainingFeature(Association newContainingFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__CONTAINING_FEATURE, oldContainingFeature, containingFeature));
	}
	...
	public Selection getSelection() {
		if (selection != null && selection.eIsProxy()) {
			...
			if (selection != oldSelection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.INDEX_UNIT__SELECTION, oldSelection, selection));
			}
		}
		return selection;
	}
	...
	public void setSelection(Selection newSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__SELECTION, oldSelection, selection));
	}
	...
	public EList<Filter> getFilters() {
		if (filters == null) {
			filters = new EObjectContainmentEList<Filter>(Filter.class, this, WebGenWebUIPackage.INDEX_UNIT__FILTERS);
		}
		return filters;
	}
	...
	public void setEmptyMessage(String newEmptyMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__EMPTY_MESSAGE, oldEmptyMessage, emptyMessage));
	}
	...
	public Filter getPagination() {
		if (pagination != null && pagination.eIsProxy()) {
			...
			if (pagination != oldPagination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.INDEX_UNIT__PAGINATION, oldPagination, pagination));
			}
		}
		return pagination;
	}
	...
	public void setPagination(Filter newPagination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__PAGINATION, oldPagination, pagination));
	}
	...
	public void setDefaultPaginationSize(int newDefaultPaginationSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__DEFAULT_PAGINATION_SIZE, oldDefaultPaginationSize, defaultPaginationSize));
	}
	...
	public void setNextNpages(int newNextNpages) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__NEXT_NPAGES, oldNextNpages, nextNpages));
	}
	...
	public void setPreviousNpages(int newPreviousNpages) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__PREVIOUS_NPAGES, oldPreviousNpages, previousNpages));
	}
	...
	public void setNextPageLabel(String newNextPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__NEXT_PAGE_LABEL, oldNextPageLabel, nextPageLabel));
	}
	...
	public void setPreviousPageLabel(String newPreviousPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__PREVIOUS_PAGE_LABEL, oldPreviousPageLabel, previousPageLabel));
	}
	...
	public void setUseDisabledPageLinks(boolean newUseDisabledPageLinks) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__USE_DISABLED_PAGE_LINKS, oldUseDisabledPageLinks, useDisabledPageLinks));
	}
	...
	public void setUseFirstLastPageLinks(boolean newUseFirstLastPageLinks) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__USE_FIRST_LAST_PAGE_LINKS, oldUseFirstLastPageLinks, useFirstLastPageLinks));
	}
	...
	public void setFirstPageLabel(String newFirstPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__FIRST_PAGE_LABEL, oldFirstPageLabel, firstPageLabel));
	}
	...
	public void setLastPageLabel(String newLastPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__LAST_PAGE_LABEL, oldLastPageLabel, lastPageLabel));
	}
	...
	public EList<InlineAction> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentWithInverseEList<InlineAction>(InlineAction.class, this, WebGenWebUIPackage.INDEX_UNIT__ACTIONS, WebGenWebUIPackage.INLINE_ACTION__USED_BY);
		}
		return actions;
	}
	...
	public void setDisplayOption(IndexDisplayOption newDisplayOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__DISPLAY_OPTION, oldDisplayOption, displayOption));
	}
	...
	public void setOmitColumnLabels(boolean newOmitColumnLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__OMIT_COLUMN_LABELS, oldOmitColumnLabels, omitColumnLabels));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public void setRowClasses(String newRowClasses) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.INDEX_UNIT__ROW_CLASSES, oldRowClasses, rowClasses));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.INDEX_UNIT__ACTIONS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.INDEX_UNIT__FILTERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.INDEX_UNIT__SELECTION_TYPE:
				if (resolve) return getSelectionType();
				return basicGetSelectionType();
			case WebGenWebUIPackage.INDEX_UNIT__CONTENT_TYPE:
				return getContentType();
			case WebGenWebUIPackage.INDEX_UNIT__CONTAINING_FEATURE:
				if (resolve) return getContainingFeature();
				return basicGetContainingFeature();
			case WebGenWebUIPackage.INDEX_UNIT__SELECTION:
				if (resolve) return getSelection();
				return basicGetSelection();
			case WebGenWebUIPackage.INDEX_UNIT__FILTERS:
				return getFilters();
			case WebGenWebUIPackage.INDEX_UNIT__EMPTY_MESSAGE:
				return getEmptyMessage();
			case WebGenWebUIPackage.INDEX_UNIT__PAGINATION:
				if (resolve) return getPagination();
				return basicGetPagination();
			case WebGenWebUIPackage.INDEX_UNIT__DEFAULT_PAGINATION_SIZE:
				return getDefaultPaginationSize();
			case WebGenWebUIPackage.INDEX_UNIT__NEXT_NPAGES:
				return getNextNpages();
			case WebGenWebUIPackage.INDEX_UNIT__PREVIOUS_NPAGES:
				return getPreviousNpages();
			case WebGenWebUIPackage.INDEX_UNIT__NEXT_PAGE_LABEL:
				return getNextPageLabel();
			case WebGenWebUIPackage.INDEX_UNIT__PREVIOUS_PAGE_LABEL:
				return getPreviousPageLabel();
			case WebGenWebUIPackage.INDEX_UNIT__USE_DISABLED_PAGE_LINKS:
				return isUseDisabledPageLinks();
			case WebGenWebUIPackage.INDEX_UNIT__USE_FIRST_LAST_PAGE_LINKS:
				return isUseFirstLastPageLinks();
			case WebGenWebUIPackage.INDEX_UNIT__FIRST_PAGE_LABEL:
				return getFirstPageLabel();
			case WebGenWebUIPackage.INDEX_UNIT__LAST_PAGE_LABEL:
				return getLastPageLabel();
			case WebGenWebUIPackage.INDEX_UNIT__ACTIONS:
				return getActions();
			case WebGenWebUIPackage.INDEX_UNIT__DISPLAY_OPTION:
				return getDisplayOption();
			case WebGenWebUIPackage.INDEX_UNIT__OMIT_COLUMN_LABELS:
				return isOmitColumnLabels();
			case WebGenWebUIPackage.INDEX_UNIT__STYLE_CLASS:
				return getStyleClass();
			case WebGenWebUIPackage.INDEX_UNIT__CONTENT_CLASS:
				return getContentClass();
			case WebGenWebUIPackage.INDEX_UNIT__ROW_CLASSES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SelectableUnit.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.INDEX_UNIT__SELECTION_TYPE: return WebGenWebUIPackage.SELECTABLE_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
		if (baseClass == CollectionUnit.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.INDEX_UNIT__CONTENT_TYPE: return WebGenWebUIPackage.COLLECTION_UNIT__CONTENT_TYPE;
				case WebGenWebUIPackage.INDEX_UNIT__CONTAINING_FEATURE: return WebGenWebUIPackage.COLLECTION_UNIT__CONTAINING_FEATURE;
				case WebGenWebUIPackage.INDEX_UNIT__SELECTION: return WebGenWebUIPackage.COLLECTION_UNIT__SELECTION;
				case WebGenWebUIPackage.INDEX_UNIT__FILTERS: return WebGenWebUIPackage.COLLECTION_UNIT__FILTERS;
				case WebGenWebUIPackage.INDEX_UNIT__EMPTY_MESSAGE: return WebGenWebUIPackage.COLLECTION_UNIT__EMPTY_MESSAGE;
				case WebGenWebUIPackage.INDEX_UNIT__PAGINATION: return WebGenWebUIPackage.COLLECTION_UNIT__PAGINATION;
				case WebGenWebUIPackage.INDEX_UNIT__DEFAULT_PAGINATION_SIZE: return WebGenWebUIPackage.COLLECTION_UNIT__DEFAULT_PAGINATION_SIZE;
				case WebGenWebUIPackage.INDEX_UNIT__NEXT_NPAGES: return WebGenWebUIPackage.COLLECTION_UNIT__NEXT_NPAGES;
				case WebGenWebUIPackage.INDEX_UNIT__PREVIOUS_NPAGES: return WebGenWebUIPackage.COLLECTION_UNIT__PREVIOUS_NPAGES;
				case WebGenWebUIPackage.INDEX_UNIT__NEXT_PAGE_LABEL: return WebGenWebUIPackage.COLLECTION_UNIT__NEXT_PAGE_LABEL;
				case WebGenWebUIPackage.INDEX_UNIT__PREVIOUS_PAGE_LABEL: return WebGenWebUIPackage.COLLECTION_UNIT__PREVIOUS_PAGE_LABEL;
				case WebGenWebUIPackage.INDEX_UNIT__USE_DISABLED_PAGE_LINKS: return WebGenWebUIPackage.COLLECTION_UNIT__USE_DISABLED_PAGE_LINKS;
				case WebGenWebUIPackage.INDEX_UNIT__USE_FIRST_LAST_PAGE_LINKS: return WebGenWebUIPackage.COLLECTION_UNIT__USE_FIRST_LAST_PAGE_LINKS;
				case WebGenWebUIPackage.INDEX_UNIT__FIRST_PAGE_LABEL: return WebGenWebUIPackage.COLLECTION_UNIT__FIRST_PAGE_LABEL;
				case WebGenWebUIPackage.INDEX_UNIT__LAST_PAGE_LABEL: return WebGenWebUIPackage.COLLECTION_UNIT__LAST_PAGE_LABEL;
				default: return -1;
			}
		}
		if (baseClass == InlineActionContainer.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.INDEX_UNIT__ACTIONS: return WebGenWebUIPackage.INLINE_ACTION_CONTAINER__ACTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SelectableUnit.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.SELECTABLE_UNIT__SELECTION_TYPE: return WebGenWebUIPackage.INDEX_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
		if (baseClass == CollectionUnit.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.COLLECTION_UNIT__CONTENT_TYPE: return WebGenWebUIPackage.INDEX_UNIT__CONTENT_TYPE;
				case WebGenWebUIPackage.COLLECTION_UNIT__CONTAINING_FEATURE: return WebGenWebUIPackage.INDEX_UNIT__CONTAINING_FEATURE;
				case WebGenWebUIPackage.COLLECTION_UNIT__SELECTION: return WebGenWebUIPackage.INDEX_UNIT__SELECTION;
				case WebGenWebUIPackage.COLLECTION_UNIT__FILTERS: return WebGenWebUIPackage.INDEX_UNIT__FILTERS;
				case WebGenWebUIPackage.COLLECTION_UNIT__EMPTY_MESSAGE: return WebGenWebUIPackage.INDEX_UNIT__EMPTY_MESSAGE;
				case WebGenWebUIPackage.COLLECTION_UNIT__PAGINATION: return WebGenWebUIPackage.INDEX_UNIT__PAGINATION;
				case WebGenWebUIPackage.COLLECTION_UNIT__DEFAULT_PAGINATION_SIZE: return WebGenWebUIPackage.INDEX_UNIT__DEFAULT_PAGINATION_SIZE;
				case WebGenWebUIPackage.COLLECTION_UNIT__NEXT_NPAGES: return WebGenWebUIPackage.INDEX_UNIT__NEXT_NPAGES;
				case WebGenWebUIPackage.COLLECTION_UNIT__PREVIOUS_NPAGES: return WebGenWebUIPackage.INDEX_UNIT__PREVIOUS_NPAGES;
				case WebGenWebUIPackage.COLLECTION_UNIT__NEXT_PAGE_LABEL: return WebGenWebUIPackage.INDEX_UNIT__NEXT_PAGE_LABEL;
				case WebGenWebUIPackage.COLLECTION_UNIT__PREVIOUS_PAGE_LABEL: return WebGenWebUIPackage.INDEX_UNIT__PREVIOUS_PAGE_LABEL;
				case WebGenWebUIPackage.COLLECTION_UNIT__USE_DISABLED_PAGE_LINKS: return WebGenWebUIPackage.INDEX_UNIT__USE_DISABLED_PAGE_LINKS;
				case WebGenWebUIPackage.COLLECTION_UNIT__USE_FIRST_LAST_PAGE_LINKS: return WebGenWebUIPackage.INDEX_UNIT__USE_FIRST_LAST_PAGE_LINKS;
				case WebGenWebUIPackage.COLLECTION_UNIT__FIRST_PAGE_LABEL: return WebGenWebUIPackage.INDEX_UNIT__FIRST_PAGE_LABEL;
				case WebGenWebUIPackage.COLLECTION_UNIT__LAST_PAGE_LABEL: return WebGenWebUIPackage.INDEX_UNIT__LAST_PAGE_LABEL;
				default: return -1;
			}
		}
		if (baseClass == InlineActionContainer.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.INLINE_ACTION_CONTAINER__ACTIONS: return WebGenWebUIPackage.INDEX_UNIT__ACTIONS;
				default: return -1;
			}
		}
