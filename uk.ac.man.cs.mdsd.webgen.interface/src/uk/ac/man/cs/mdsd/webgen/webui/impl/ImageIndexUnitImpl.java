...
public class ImageIndexUnitImpl extends ImageUnitImpl implements ImageIndexUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.IMAGE_INDEX_UNIT;
	}
	...
	public EList<InlineAction> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentWithInverseEList<InlineAction>(InlineAction.class, this, WebGenWebUIPackage.IMAGE_INDEX_UNIT__ACTIONS, WebGenWebUIPackage.INLINE_ACTION__USED_BY);
		}
		return actions;
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.IMAGE_INDEX_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.IMAGE_INDEX_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.IMAGE_INDEX_UNIT__ACTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.IMAGE_INDEX_UNIT__ACTIONS:
				return getActions();
			case WebGenWebUIPackage.IMAGE_INDEX_UNIT__STYLE_CLASS:
				return getStyleClass();
			case WebGenWebUIPackage.IMAGE_INDEX_UNIT__CONTENT_CLASS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == InlineActionContainer.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.IMAGE_INDEX_UNIT__ACTIONS: return WebGenWebUIPackage.INLINE_ACTION_CONTAINER__ACTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == InlineActionContainer.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.INLINE_ACTION_CONTAINER__ACTIONS: return WebGenWebUIPackage.IMAGE_INDEX_UNIT__ACTIONS;
				default: return -1;
			}
		}
