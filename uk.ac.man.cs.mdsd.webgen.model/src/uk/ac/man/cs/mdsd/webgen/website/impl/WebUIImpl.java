 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getMenus <em>Menus</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getPages <em>Pages</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getInputTechnology <em>Input Technology</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getAjaxTechnology <em>Ajax Technology</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getDefaultDateFormat <em>Default Date Format</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getDefaultTimeFormat <em>Default Time Format</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getDefaultDateTimeFormat <em>Default Date Time Format</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getDefaultMaximumUploadSize <em>Default Maximum Upload Size</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#isResponsiveTopMenu <em>Responsive Top Menu</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getTopNavigationId <em>Top Navigation Id</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getSideMenu <em>Side Menu</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getSiteTemplate <em>Site Template</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#isStaticUnitsEditable <em>Static Units Editable</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.WebUIImpl#getTextEditorURL <em>Text Editor URL</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WebUIImpl extends EObjectImpl implements WebUI {
	/**
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.WEB_UI;
	}
	...
	public List<Page> getPages() {
		if (pages == null) {
			pages = new EObjectContainmentEList<Page>(Page.class, this, WebsitePackage.WEB_UI__PAGES);
		}
		return pages;
	}
	...
	public void setInputTechnology(InputTechnologies newInputTechnology) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__INPUT_TECHNOLOGY, oldInputTechnology, inputTechnology));
	}
	...
	public void setAjaxTechnology(AjaxTechnologies newAjaxTechnology) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__AJAX_TECHNOLOGY, oldAjaxTechnology, ajaxTechnology));
	}
	...
	public void setDefaultDateFormat(String newDefaultDateFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__DEFAULT_DATE_FORMAT, oldDefaultDateFormat, defaultDateFormat));
	}
	...
	public void setDefaultTimeFormat(String newDefaultTimeFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__DEFAULT_TIME_FORMAT, oldDefaultTimeFormat, defaultTimeFormat));
	}
	...
	public void setDefaultDateTimeFormat(String newDefaultDateTimeFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__DEFAULT_DATE_TIME_FORMAT, oldDefaultDateTimeFormat, defaultDateTimeFormat));
	}
	...
	public void setDefaultMaximumUploadSize(int newDefaultMaximumUploadSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__DEFAULT_MAXIMUM_UPLOAD_SIZE, oldDefaultMaximumUploadSize, defaultMaximumUploadSize));
	}
	...
	public void setResponsiveTopMenu(boolean newResponsiveTopMenu) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__RESPONSIVE_TOP_MENU, oldResponsiveTopMenu, responsiveTopMenu));
	}
	...
	public void setTopNavigationId(String newTopNavigationId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__TOP_NAVIGATION_ID, oldTopNavigationId, topNavigationId));
	}
	...
	public Menu getSideMenu() {
		if (sideMenu != null && sideMenu.eIsProxy()) {
			...
			if (sideMenu != oldSideMenu) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.WEB_UI__SIDE_MENU, oldSideMenu, sideMenu));
			}
		}
		return sideMenu;
	}
	...
	public void setSideMenu(Menu newSideMenu) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__SIDE_MENU, oldSideMenu, sideMenu));
	}
	...
	public void setSiteTemplate(String newSiteTemplate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__SITE_TEMPLATE, oldSiteTemplate, siteTemplate));
	}
	...
	public void setStaticUnitsEditable(boolean newStaticUnitsEditable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__STATIC_UNITS_EDITABLE, oldStaticUnitsEditable, staticUnitsEditable));
	}
	...
	public void setTextEditorURL(String newTextEditorURL) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEB_UI__TEXT_EDITOR_URL, oldTextEditorURL, textEditorURL));
	}
	...
	public List<Menu> getMenus() {
		if (menus == null) {
			menus = new EObjectContainmentEList<Menu>(Menu.class, this, WebsitePackage.WEB_UI__MENUS);
		}
		return menus;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WebsitePackage.WEB_UI__SIDE_MENU:
