 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.PageLinkImpl#getTargetPage <em>Target Page</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PageLinkImpl extends MinimalEObjectImpl.Container implements PageLink {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.PAGE_LINK;
	}
		...
		if (targetPage != null && targetPage.eIsProxy()) {
			...
			if (targetPage != oldTargetPage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.PAGE_LINK__TARGET_PAGE, oldTargetPage, targetPage));
			}
		}
		return targetPage;
	}
	...
	public NotificationChain basicSetTargetPage(Page newTargetPage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.PAGE_LINK__TARGET_PAGE, oldTargetPage, newTargetPage);
	...
	public void setTargetPage(Page newTargetPage) {
		if (newTargetPage != targetPage) {
			...
			if (targetPage != null)
				msgs = ((InternalEObject)targetPage).eInverseRemove(this, WebGenInterfacePackage.PAGE__CHILD_PAGES, Page.class, msgs);
			if (newTargetPage != null)
				msgs = ((InternalEObject)newTargetPage).eInverseAdd(this, WebGenInterfacePackage.PAGE__CHILD_PAGES, Page.class, msgs);
			msgs = basicSetTargetPage(newTargetPage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.PAGE_LINK__TARGET_PAGE, newTargetPage, newTargetPage));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenInterfacePackage.PAGE_LINK__TARGET_PAGE:
				if (targetPage != null)
					msgs = ((InternalEObject)targetPage).eInverseRemove(this, WebGenInterfacePackage.PAGE__CHILD_PAGES, Page.class, msgs);
