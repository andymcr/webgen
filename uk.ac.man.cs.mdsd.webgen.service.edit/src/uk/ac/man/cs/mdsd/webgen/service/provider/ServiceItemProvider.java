...
public class ServiceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenServicePackage.Literals.SERVICE__SERVES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebGenServicePackage.Literals.SERVICE__SELECTIONS);
			childrenFeatures.add(WebGenServicePackage.Literals.SERVICE__OPERATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebGenServicePackage.Literals.SERVICE__SELECTIONS,
				 WebGenServiceFactory.eINSTANCE.createSelection()));

		newChildDescriptors.add
			(createChildParameter
				(WebGenServicePackage.Literals.SERVICE__OPERATIONS,
				 WebGenServiceFactory.eINSTANCE.createBusinessOperation()));
	}
