...
public class ChildPathAssociationImpl extends ChildPathImpl implements ChildPathAssociation {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate IS_SOURCE_ASSOCIATION__ESETTING_DELEGATE = ((EStructuralFeature.Internal)WebGenWebUIPackage.Literals.CHILD_PATH_ASSOCIATION__IS_SOURCE_ASSOCIATION).getSettingDelegate();
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate SOURCE_ENTITY__ESETTING_DELEGATE = ((EStructuralFeature.Internal)WebGenWebUIPackage.Literals.CHILD_PATH_ASSOCIATION__SOURCE_ENTITY).getSettingDelegate();
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate TARGET_ENTITY__ESETTING_DELEGATE = ((EStructuralFeature.Internal)WebGenWebUIPackage.Literals.CHILD_PATH_ASSOCIATION__TARGET_ENTITY).getSettingDelegate();
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.CHILD_PATH_ASSOCIATION;
	}
		...
		if (association != null && association.eIsProxy()) {
			...
			if (association != oldAssociation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__ASSOCIATION, oldAssociation, association));
			}
		}
		return association;
	}
	...
	public void setAssociation(Association newAssociation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__ASSOCIATION, oldAssociation, association));
	}
	...
	public Label getValueDisplay() {
		if (valueDisplay != null && valueDisplay.eIsProxy()) {
			...
			if (valueDisplay != oldValueDisplay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__VALUE_DISPLAY, oldValueDisplay, valueDisplay));
			}
		}
		return valueDisplay;
	}
	...
	public void setValueDisplay(Label newValueDisplay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__VALUE_DISPLAY, oldValueDisplay, valueDisplay));
	}
	...
	public NotificationChain basicSetChildFeature(ChildPath newChildFeature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__CHILD_FEATURE, oldChildFeature, newChildFeature);
	...
	public void setChildFeature(ChildPath newChildFeature) {
		if (newChildFeature != childFeature) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__CHILD_FEATURE, newChildFeature, newChildFeature));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__CHILD_FEATURE:
				if (childFeature != null)
					msgs = ((InternalEObject)childFeature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__CHILD_FEATURE, null, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__NAME:
				return getName();
			case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__ASSOCIATION:
				if (resolve) return getAssociation();
				return basicGetAssociation();
			case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__VALUE_DISPLAY:
				if (resolve) return getValueDisplay();
				return basicGetValueDisplay();
			case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__CHILD_FEATURE:
				return getChildFeature();
			case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__IS_SOURCE_ASSOCIATION:
				return isIsSourceAssociation();
			case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__SOURCE_ENTITY:
				if (resolve) return getSourceEntity();
				return basicGetSourceEntity();
			case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__TARGET_ENTITY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AssociationReference.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__NAME: return WebGenWebUIPackage.ASSOCIATION_REFERENCE__NAME;
				case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__ASSOCIATION: return WebGenWebUIPackage.ASSOCIATION_REFERENCE__ASSOCIATION;
				case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__VALUE_DISPLAY: return WebGenWebUIPackage.ASSOCIATION_REFERENCE__VALUE_DISPLAY;
				case WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__CHILD_FEATURE: return WebGenWebUIPackage.ASSOCIATION_REFERENCE__CHILD_FEATURE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AssociationReference.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.ASSOCIATION_REFERENCE__NAME: return WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__NAME;
				case WebGenWebUIPackage.ASSOCIATION_REFERENCE__ASSOCIATION: return WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__ASSOCIATION;
				case WebGenWebUIPackage.ASSOCIATION_REFERENCE__VALUE_DISPLAY: return WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__VALUE_DISPLAY;
				case WebGenWebUIPackage.ASSOCIATION_REFERENCE__CHILD_FEATURE: return WebGenWebUIPackage.CHILD_PATH_ASSOCIATION__CHILD_FEATURE;
				default: return -1;
			}
		}
