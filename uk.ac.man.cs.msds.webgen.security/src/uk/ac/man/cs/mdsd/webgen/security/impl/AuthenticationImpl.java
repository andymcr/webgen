...
public abstract class AuthenticationImpl extends MinimalEObjectImpl.Container implements Authentication {
	...
	protected EClass eStaticClass() {
		return WebGenSecurityPackage.Literals.AUTHENTICATION;
	}
	...
	public void setLoginLabel(String newLoginLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenSecurityPackage.AUTHENTICATION__LOGIN_LABEL, oldLoginLabel, loginLabel));
	}
	...
	public void setLogoutLabel(String newLogoutLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenSecurityPackage.AUTHENTICATION__LOGOUT_LABEL, oldLogoutLabel, logoutLabel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenSecurityPackage.AUTHENTICATION__LOGIN_LABEL:
				return getLoginLabel();
			case WebGenSecurityPackage.AUTHENTICATION__LOGOUT_LABEL:
