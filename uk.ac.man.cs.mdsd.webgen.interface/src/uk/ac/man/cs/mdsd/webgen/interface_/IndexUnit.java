 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.IndexUnit#getDisplayOption <em>Display Option</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.IndexUnit#isOmitColumnLabels <em>Omit Column Labels</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.IndexUnit#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.IndexUnit#getContentClass <em>Content Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.IndexUnit#getRowClasses <em>Row Classes</em>}</li>
 * </ul>
 *
 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getIndexUnit()
...
public interface IndexUnit extends DataUnit, CollectionUnit, InlineActionContainer {
	 ...
	 * The literals are from the enumeration {@link uk.ac.man.cs.mdsd.webgen.interface_.IndexDisplayOption}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getIndexUnit_DisplayOption()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.IndexUnit#getDisplayOption <em>Display Option</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getIndexUnit_OmitColumnLabels()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.IndexUnit#isOmitColumnLabels <em>Omit Column Labels</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getIndexUnit_StyleClass()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.IndexUnit#getStyleClass <em>Style Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getIndexUnit_ContentClass()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.IndexUnit#getContentClass <em>Content Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getIndexUnit_RowClasses()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.IndexUnit#getRowClasses <em>Row Classes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
