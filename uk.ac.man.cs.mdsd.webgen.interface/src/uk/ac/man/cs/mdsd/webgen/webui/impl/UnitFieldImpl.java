...
public abstract class UnitFieldImpl extends MinimalEObjectImpl.Container implements UnitField {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.UNIT_FIELD;
	}
	...
	public DynamicUnit getDisplayedOn() {
		if (eContainerFeatureID() != WebGenWebUIPackage.UNIT_FIELD__DISPLAYED_ON) return null;
	...
	public NotificationChain basicSetDisplayedOn(DynamicUnit newDisplayedOn, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDisplayedOn, WebGenWebUIPackage.UNIT_FIELD__DISPLAYED_ON, msgs);
		return msgs;
	}
	...
	public void setDisplayedOn(DynamicUnit newDisplayedOn) {
		if (newDisplayedOn != eInternalContainer() || (eContainerFeatureID() != WebGenWebUIPackage.UNIT_FIELD__DISPLAYED_ON && newDisplayedOn != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FIELD__DISPLAYED_ON, newDisplayedOn, newDisplayedOn));
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FIELD__TITLE, oldTitle, title));
	}
	...
	public void setCollectionDisplayOption(CollectionDisplayOptions newCollectionDisplayOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FIELD__COLLECTION_DISPLAY_OPTION, oldCollectionDisplayOption, collectionDisplayOption));
	}
	...
	public void setCollectionAllowAdd(boolean newCollectionAllowAdd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FIELD__COLLECTION_ALLOW_ADD, oldCollectionAllowAdd, collectionAllowAdd));
	}
	...
	public void setCollectionAllowRemove(boolean newCollectionAllowRemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FIELD__COLLECTION_ALLOW_REMOVE, oldCollectionAllowRemove, collectionAllowRemove));
	}
	...
	public void setMaximumDisplaySize(int newMaximumDisplaySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FIELD__MAXIMUM_DISPLAY_SIZE, oldMaximumDisplaySize, maximumDisplaySize));
	}
	...
	public void setDateFormat(String newDateFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FIELD__DATE_FORMAT, oldDateFormat, dateFormat));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.UNIT_FIELD__DISPLAYED_ON:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WebGenWebUIPackage.UNIT_FIELD__TITLE:
				return getTitle();
			case WebGenWebUIPackage.UNIT_FIELD__COLLECTION_DISPLAY_OPTION:
				return getCollectionDisplayOption();
			case WebGenWebUIPackage.UNIT_FIELD__COLLECTION_ALLOW_ADD:
				return isCollectionAllowAdd();
			case WebGenWebUIPackage.UNIT_FIELD__COLLECTION_ALLOW_REMOVE:
				return isCollectionAllowRemove();
			case WebGenWebUIPackage.UNIT_FIELD__MAXIMUM_DISPLAY_SIZE:
				return getMaximumDisplaySize();
			case WebGenWebUIPackage.UNIT_FIELD__DATE_FORMAT:
