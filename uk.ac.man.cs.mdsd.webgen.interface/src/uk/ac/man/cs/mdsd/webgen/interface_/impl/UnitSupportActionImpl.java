 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitSupportActionImpl#isDisable <em>Disable</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.UnitSupportActionImpl#getConfirmMessage <em>Confirm Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnitSupportActionImpl extends NamedDisplayElementImpl implements UnitSupportAction {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.UNIT_SUPPORT_ACTION;
	}
	...
	public void setDisable(boolean newDisable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_SUPPORT_ACTION__DISABLE, oldDisable, disable));
	}
	...
	public void setConfirmMessage(String newConfirmMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.UNIT_SUPPORT_ACTION__CONFIRM_MESSAGE, oldConfirmMessage, confirmMessage));
	}
