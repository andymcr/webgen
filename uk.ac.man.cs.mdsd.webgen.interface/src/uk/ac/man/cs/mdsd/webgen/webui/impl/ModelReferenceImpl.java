 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.ModelReferenceImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelReferenceImpl extends MinimalEObjectImpl.Container implements ModelReference {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.MODEL_REFERENCE;
	}
		...
		if (unit != null && unit.eIsProxy()) {
			...
			if (unit != oldUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.MODEL_REFERENCE__UNIT, oldUnit, unit));
			}
		}
		return unit;
	}
	...
	public void setUnit(DynamicUnit newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MODEL_REFERENCE__UNIT, oldUnit, unit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.MODEL_REFERENCE__UNIT:
