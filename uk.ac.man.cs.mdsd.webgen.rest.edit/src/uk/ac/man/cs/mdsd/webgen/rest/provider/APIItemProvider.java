...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.rest.API} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class APIItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebGenRestPackage.Literals.API__RESOURCES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(API.class)) {
			case WebGenRestPackage.API__RESOURCES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebGenRestPackage.Literals.API__RESOURCES,
				 WebGenRestFactory.eINSTANCE.createResource()));
	}
