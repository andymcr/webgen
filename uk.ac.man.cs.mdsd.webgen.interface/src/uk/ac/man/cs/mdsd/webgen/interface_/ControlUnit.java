 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.ControlUnit#getSubmitLabel <em>Submit Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.ControlUnit#getCancelDestination <em>Cancel Destination</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.ControlUnit#getCancelLabel <em>Cancel Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.ControlUnit#getContentClass <em>Content Class</em>}</li>
 * </ul>
 *
 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getControlUnit()
 * @model abstract="true"
 * @generated
 */
public interface ControlUnit extends DynamicUnit {
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getControlUnit_SubmitLabel()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.ControlUnit#getSubmitLabel <em>Submit Label</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getControlUnit_CancelDestination()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.ControlUnit#getCancelDestination <em>Cancel Destination</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getControlUnit_CancelLabel()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.ControlUnit#getCancelLabel <em>Cancel Label</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.interface_.WebGenInterfacePackage#getControlUnit_ContentClass()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.webgen.interface_.ControlUnit#getContentClass <em>Content Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
