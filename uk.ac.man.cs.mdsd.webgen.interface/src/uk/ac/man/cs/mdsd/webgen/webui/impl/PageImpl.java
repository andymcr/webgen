...
public class PageImpl extends NamedDisplayElementImpl implements Page {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.PAGE;
	}
	...
	public EList<ContentUnit> getUnits() {
		if (units == null) {
			units = new EObjectContainmentWithInverseEList<ContentUnit>(ContentUnit.class, this, WebGenWebUIPackage.PAGE__UNITS, WebGenWebUIPackage.CONTENT_UNIT__DISPLAYED_ON);
		}
		return units;
	}
	...
	public NotificationChain basicSetParentPage(PageLink newParentPage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.PAGE__PARENT_PAGE, oldParentPage, newParentPage);
	...
	public void setParentPage(PageLink newParentPage) {
		if (newParentPage != parentPage) {
			...
			if (parentPage != null)
				msgs = ((InternalEObject)parentPage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.PAGE__PARENT_PAGE, null, msgs);
			if (newParentPage != null)
				msgs = ((InternalEObject)newParentPage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.PAGE__PARENT_PAGE, null, msgs);
			msgs = basicSetParentPage(newParentPage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.PAGE__PARENT_PAGE, newParentPage, newParentPage));
	}
	...
	public EList<PageLink> getChildPages() {
		if (childPages == null) {
			childPages = new EObjectWithInverseResolvingEList<PageLink>(PageLink.class, this, WebGenWebUIPackage.PAGE__CHILD_PAGES, WebGenWebUIPackage.PAGE_LINK__TARGET_PAGE);
		}
		return childPages;
	}
	...
	public void setAuthenticated(boolean newAuthenticated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.PAGE__AUTHENTICATED, oldAuthenticated, authenticated));
	}
	...
	public void setUriElement(String newUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.PAGE__URI_ELEMENT, oldUriElement, uriElement));
	}
	...
	public void setTopMenuOption(PageTopMenuOptions newTopMenuOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.PAGE__TOP_MENU_OPTION, oldTopMenuOption, topMenuOption));
	}
	...
	public void setTopMenuRank(int newTopMenuRank) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.PAGE__TOP_MENU_RANK, oldTopMenuRank, topMenuRank));
	}
	...
	public void setNavigationLabel(String newNavigationLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.PAGE__NAVIGATION_LABEL, oldNavigationLabel, navigationLabel));
	}
	...
	public Menu getSideMenu() {
		if (sideMenu != null && sideMenu.eIsProxy()) {
			...
			if (sideMenu != oldSideMenu) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.PAGE__SIDE_MENU, oldSideMenu, sideMenu));
			}
		}
		return sideMenu;
	}
	...
	public void setSideMenu(Menu newSideMenu) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.PAGE__SIDE_MENU, oldSideMenu, sideMenu));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.PAGE__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WebGenWebUIPackage.PAGE__PARENT_PAGE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WebGenWebUIPackage.PAGE__AUTHENTICATED:
				return isAuthenticated();
			case WebGenWebUIPackage.PAGE__URI_ELEMENT:
				return getUriElement();
			case WebGenWebUIPackage.PAGE__TOP_MENU_OPTION:
				return getTopMenuOption();
			case WebGenWebUIPackage.PAGE__TOP_MENU_RANK:
				return getTopMenuRank();
			case WebGenWebUIPackage.PAGE__NAVIGATION_LABEL:
				return getNavigationLabel();
			case WebGenWebUIPackage.PAGE__SIDE_MENU:
				if (resolve) return getSideMenu();
				return basicGetSideMenu();
			case WebGenWebUIPackage.PAGE__STYLE_CLASS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == UnitContainer.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.PAGE__UNITS: return WebGenWebUIPackage.UNIT_CONTAINER__UNITS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == UnitContainer.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.UNIT_CONTAINER__UNITS: return WebGenWebUIPackage.PAGE__UNITS;
				default: return -1;
			}
		}
