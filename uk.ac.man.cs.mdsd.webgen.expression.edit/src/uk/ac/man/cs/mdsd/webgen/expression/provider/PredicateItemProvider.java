...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.expression.Predicate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PredicateItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenExpressionPackage.Literals.PREDICATE__NEGATED,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Predicate_type") + " " + predicate.isNegated();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Predicate.class)) {
			case WebGenExpressionPackage.PREDICATE__NEGATED:
