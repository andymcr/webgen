 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.MenuEntryImpl#getPartOf <em>Part Of</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.MenuEntryImpl#getRequiresRole <em>Requires Role</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MenuEntryImpl extends MinimalEObjectImpl.Container implements MenuEntry {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.MENU_ENTRY;
	}
	...
	public Menu getPartOf() {
		if (eContainerFeatureID() != WebGenWebUIPackage.MENU_ENTRY__PART_OF) return null;
	...
	public NotificationChain basicSetPartOf(Menu newPartOf, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPartOf, WebGenWebUIPackage.MENU_ENTRY__PART_OF, msgs);
		return msgs;
	}
	...
	public void setPartOf(Menu newPartOf) {
		if (newPartOf != eInternalContainer() || (eContainerFeatureID() != WebGenWebUIPackage.MENU_ENTRY__PART_OF && newPartOf != null)) {
			...
			if (newPartOf != null)
				msgs = ((InternalEObject)newPartOf).eInverseAdd(this, WebGenWebUIPackage.MENU__ENTRIES, Menu.class, msgs);
			msgs = basicSetPartOf(newPartOf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MENU_ENTRY__PART_OF, newPartOf, newPartOf));
	}
	...
	public void setRequiresRole(String newRequiresRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MENU_ENTRY__REQUIRES_ROLE, oldRequiresRole, requiresRole));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.MENU_ENTRY__PART_OF:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case WebGenWebUIPackage.MENU_ENTRY__PART_OF:
				return eInternalContainer().eInverseRemove(this, WebGenWebUIPackage.MENU__ENTRIES, Menu.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.MENU_ENTRY__PART_OF:
				return getPartOf();
			case WebGenWebUIPackage.MENU_ENTRY__REQUIRES_ROLE:
