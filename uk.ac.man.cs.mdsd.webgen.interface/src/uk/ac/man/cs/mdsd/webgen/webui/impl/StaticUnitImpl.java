 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.StaticUnitImpl#getContent <em>Content</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.StaticUnitImpl#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.StaticUnitImpl#getContentClass <em>Content Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StaticUnitImpl extends ContentUnitImpl implements StaticUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.STATIC_UNIT;
	}
	...
	public void setContent(String newContent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.STATIC_UNIT__CONTENT, oldContent, content));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.STATIC_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.STATIC_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.STATIC_UNIT__CONTENT:
				return getContent();
			case WebGenWebUIPackage.STATIC_UNIT__STYLE_CLASS:
				return getStyleClass();
			case WebGenWebUIPackage.STATIC_UNIT__CONTENT_CLASS:
