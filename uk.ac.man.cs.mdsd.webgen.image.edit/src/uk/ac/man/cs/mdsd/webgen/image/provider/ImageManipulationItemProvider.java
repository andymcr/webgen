...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.image.ImageManipulation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageManipulationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenImagePackage.Literals.IMAGE_MANIPULATION__JPEG_QUALITY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebGenImagePackage.Literals.IMAGE_MANIPULATION__FILTERS);
		}
	...
	public String getText(Object object) {
		ImageManipulation imageManipulation = (ImageManipulation)object;
		return getString("_UI_ImageManipulation_type") + " " + imageManipulation.getJpegQuality();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ImageManipulation.class)) {
			case WebGenImagePackage.IMAGE_MANIPULATION__JPEG_QUALITY:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case WebGenImagePackage.IMAGE_MANIPULATION__FILTERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebGenImagePackage.Literals.IMAGE_MANIPULATION__FILTERS,
				 WebGenImageFactory.eINSTANCE.createThumbnailFilter()));
	}
