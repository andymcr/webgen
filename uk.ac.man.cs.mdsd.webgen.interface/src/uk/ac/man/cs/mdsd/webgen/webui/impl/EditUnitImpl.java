...
public abstract class EditUnitImpl extends DynamicUnitImpl implements EditUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.EDIT_UNIT;
	}
		...
		if (contentType != null && contentType.eIsProxy()) {
			...
			if (contentType != oldContentType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.EDIT_UNIT__CONTENT_TYPE, oldContentType, contentType));
			}
		}
		return contentType;
	}
	...
	public void setContentType(EntityOrView newContentType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__CONTENT_TYPE, oldContentType, contentType));
	}
	...
	public Selection getDefaultSelection() {
		if (defaultSelection != null && defaultSelection.eIsProxy()) {
			...
			if (defaultSelection != oldDefaultSelection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.EDIT_UNIT__DEFAULT_SELECTION, oldDefaultSelection, defaultSelection));
			}
		}
	...
	public void setDefaultSelection(Selection newDefaultSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__DEFAULT_SELECTION, oldDefaultSelection, defaultSelection));
	}
	...
	public Label getTitle() {
		if (title != null && title.eIsProxy()) {
			...
			if (title != oldTitle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.EDIT_UNIT__TITLE, oldTitle, title));
			}
		}
		return title;
	}
	...
	public void setTitle(Label newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__TITLE, oldTitle, title));
	}
	...
	public NotificationChain basicSetEnableWhen(Predicate newEnableWhen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__ENABLE_WHEN, oldEnableWhen, newEnableWhen);
	...
	public void setEnableWhen(Predicate newEnableWhen) {
		if (newEnableWhen != enableWhen) {
			...
			if (enableWhen != null)
				msgs = ((InternalEObject)enableWhen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.EDIT_UNIT__ENABLE_WHEN, null, msgs);
			if (newEnableWhen != null)
				msgs = ((InternalEObject)newEnableWhen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.EDIT_UNIT__ENABLE_WHEN, null, msgs);
			msgs = basicSetEnableWhen(newEnableWhen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__ENABLE_WHEN, newEnableWhen, newEnableWhen));
	}
	...
	public Page getConfirmDestination() {
		if (confirmDestination != null && confirmDestination.eIsProxy()) {
			...
			if (confirmDestination != oldConfirmDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.EDIT_UNIT__CONFIRM_DESTINATION, oldConfirmDestination, confirmDestination));
			}
		}
	...
	public void setConfirmDestination(Page newConfirmDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__CONFIRM_DESTINATION, oldConfirmDestination, confirmDestination));
	}
	...
	public void setConfirmLabel(String newConfirmLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__CONFIRM_LABEL, oldConfirmLabel, confirmLabel));
	}
	...
	public Page getCancelDestination() {
		if (cancelDestination != null && cancelDestination.eIsProxy()) {
			...
			if (cancelDestination != oldCancelDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.EDIT_UNIT__CANCEL_DESTINATION, oldCancelDestination, cancelDestination));
			}
		}
	...
	public void setCancelDestination(Page newCancelDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__CANCEL_DESTINATION, oldCancelDestination, cancelDestination));
	}
	...
	public void setCancelLabel(String newCancelLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__CANCEL_LABEL, oldCancelLabel, cancelLabel));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public void setCustomiseValues(boolean newCustomiseValues) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.EDIT_UNIT__CUSTOMISE_VALUES, oldCustomiseValues, customiseValues));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.EDIT_UNIT__ENABLE_WHEN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.EDIT_UNIT__CONTENT_TYPE:
				if (resolve) return getContentType();
				return basicGetContentType();
			case WebGenWebUIPackage.EDIT_UNIT__DEFAULT_SELECTION:
				if (resolve) return getDefaultSelection();
				return basicGetDefaultSelection();
			case WebGenWebUIPackage.EDIT_UNIT__TITLE:
				if (resolve) return getTitle();
				return basicGetTitle();
			case WebGenWebUIPackage.EDIT_UNIT__ENABLE_WHEN:
				return getEnableWhen();
			case WebGenWebUIPackage.EDIT_UNIT__CONFIRM_DESTINATION:
				if (resolve) return getConfirmDestination();
				return basicGetConfirmDestination();
			case WebGenWebUIPackage.EDIT_UNIT__CONFIRM_LABEL:
				return getConfirmLabel();
			case WebGenWebUIPackage.EDIT_UNIT__CANCEL_DESTINATION:
				if (resolve) return getCancelDestination();
				return basicGetCancelDestination();
			case WebGenWebUIPackage.EDIT_UNIT__CANCEL_LABEL:
				return getCancelLabel();
			case WebGenWebUIPackage.EDIT_UNIT__CONTENT_CLASS:
				return getContentClass();
			case WebGenWebUIPackage.EDIT_UNIT__CUSTOMISE_VALUES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SingletonUnit.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.EDIT_UNIT__CONTENT_TYPE: return WebGenWebUIPackage.SINGLETON_UNIT__CONTENT_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SingletonUnit.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.SINGLETON_UNIT__CONTENT_TYPE: return WebGenWebUIPackage.EDIT_UNIT__CONTENT_TYPE;
				default: return -1;
			}
		}
