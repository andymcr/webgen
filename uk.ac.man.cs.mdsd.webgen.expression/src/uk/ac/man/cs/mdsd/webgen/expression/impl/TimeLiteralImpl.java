...
public class TimeLiteralImpl extends MinimalEObjectImpl.Container implements TimeLiteral {
	...
	protected EClass eStaticClass() {
		return WebGenExpressionPackage.Literals.TIME_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenExpressionPackage.TIME_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenExpressionPackage.TIME_LITERAL__VALUE:
				return getValue();
		}
