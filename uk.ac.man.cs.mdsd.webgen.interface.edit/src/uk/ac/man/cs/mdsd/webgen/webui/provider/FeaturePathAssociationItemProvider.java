		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenWebUIPackage.Literals.FEATURE_PATH_ASSOCIATION__IS_SOURCE_ASSOCIATION,
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenWebUIPackage.Literals.FEATURE_PATH_ASSOCIATION__SOURCE_ENTITY,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenWebUIPackage.Literals.FEATURE_PATH_ASSOCIATION__TARGET_ENTITY,
				 false,
				 false,
				 false,
				 null,
