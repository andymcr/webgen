 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.expression.impl.PredicateBooleanOperatorImpl#getExpressions <em>Expressions</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.expression.impl.PredicateBooleanOperatorImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PredicateBooleanOperatorImpl extends PredicateImpl implements PredicateBooleanOperator {
	...
	protected EClass eStaticClass() {
		return WebGenExpressionPackage.Literals.PREDICATE_BOOLEAN_OPERATOR;
	}
	...
	public EList<Predicate> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<Predicate>(Predicate.class, this, WebGenExpressionPackage.PREDICATE_BOOLEAN_OPERATOR__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public void setOperator(BooleanOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenExpressionPackage.PREDICATE_BOOLEAN_OPERATOR__OPERATOR, oldOperator, operator));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenExpressionPackage.PREDICATE_BOOLEAN_OPERATOR__EXPRESSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WebGenExpressionPackage.PREDICATE_BOOLEAN_OPERATOR__OPERATOR:
				return getOperator();
		}
