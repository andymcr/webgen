 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.MenuImpl#getEntries <em>Entries</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.MenuImpl#isOmitCaption <em>Omit Caption</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.MenuImpl#getCaptionClass <em>Caption Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.MenuImpl#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.MenuImpl#getLayoutClass <em>Layout Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MenuImpl extends NamedDisplayElementImpl implements Menu {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.MENU;
	}
	...
	public EList<MenuEntry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentWithInverseEList<MenuEntry>(MenuEntry.class, this, WebGenWebUIPackage.MENU__ENTRIES, WebGenWebUIPackage.MENU_ENTRY__PART_OF);
		}
		return entries;
	}
	...
	public void setOmitCaption(boolean newOmitCaption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MENU__OMIT_CAPTION, oldOmitCaption, omitCaption));
	}
	...
	public void setCaptionClass(String newCaptionClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MENU__CAPTION_CLASS, oldCaptionClass, captionClass));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MENU__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setLayoutClass(String newLayoutClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.MENU__LAYOUT_CLASS, oldLayoutClass, layoutClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.MENU__ENTRIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.MENU__ENTRIES:
				return getEntries();
			case WebGenWebUIPackage.MENU__OMIT_CAPTION:
				return isOmitCaption();
			case WebGenWebUIPackage.MENU__CAPTION_CLASS:
				return getCaptionClass();
			case WebGenWebUIPackage.MENU__STYLE_CLASS:
				return getStyleClass();
			case WebGenWebUIPackage.MENU__LAYOUT_CLASS:
