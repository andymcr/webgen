 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.CreateUpdateUnitImpl#getSelectionType <em>Selection Type</em>}</li>
...
public class CreateUpdateUnitImpl extends EditUnitImpl implements CreateUpdateUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.CREATE_UPDATE_UNIT;
	}
		...
		if (selectionType != null && selectionType.eIsProxy()) {
			...
			if (selectionType != oldSelectionType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.CREATE_UPDATE_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
			}
		}
	...
	public void setSelectionType(EntityOrView newSelectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CREATE_UPDATE_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
	}
	...
	public void setCreateUriElement(String newCreateUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CREATE_UPDATE_UNIT__CREATE_URI_ELEMENT, oldCreateUriElement, createUriElement));
	}
	...
	public void setClearLabel(String newClearLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CREATE_UPDATE_UNIT__CLEAR_LABEL, oldClearLabel, clearLabel));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CREATE_UPDATE_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.CREATE_UPDATE_UNIT__SELECTION_TYPE:
				if (resolve) return getSelectionType();
				return basicGetSelectionType();
			case WebGenWebUIPackage.CREATE_UPDATE_UNIT__CREATE_URI_ELEMENT:
				return getCreateUriElement();
			case WebGenWebUIPackage.CREATE_UPDATE_UNIT__CLEAR_LABEL:
				return getClearLabel();
			case WebGenWebUIPackage.CREATE_UPDATE_UNIT__STYLE_CLASS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SelectableUnit.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.CREATE_UPDATE_UNIT__SELECTION_TYPE: return WebGenWebUIPackage.SELECTABLE_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SelectableUnit.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.SELECTABLE_UNIT__SELECTION_TYPE: return WebGenWebUIPackage.CREATE_UPDATE_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
