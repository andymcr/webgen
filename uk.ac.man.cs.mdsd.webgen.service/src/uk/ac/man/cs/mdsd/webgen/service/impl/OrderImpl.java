 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.service.impl.OrderImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class OrderImpl extends MinimalEObjectImpl.Container implements Order {
	...
	protected EClass eStaticClass() {
		return WebGenServicePackage.Literals.ORDER;
	}
		...
		if (path != null && path.eIsProxy()) {
			...
			if (path != oldPath) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenServicePackage.ORDER__PATH, oldPath, path));
			}
		}
		return path;
	}
	...
	public void setPath(Path newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenServicePackage.ORDER__PATH, oldPath, path));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenServicePackage.ORDER__PATH:
