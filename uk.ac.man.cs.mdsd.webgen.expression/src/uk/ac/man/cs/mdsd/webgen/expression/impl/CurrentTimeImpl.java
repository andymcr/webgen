...
public class CurrentTimeImpl extends MinimalEObjectImpl.Container implements CurrentTime {
	...
	protected EClass eStaticClass() {
		return WebGenExpressionPackage.Literals.CURRENT_TIME;
	}
	...
	public void setFormat(String newFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenExpressionPackage.CURRENT_TIME__FORMAT, oldFormat, format));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenExpressionPackage.CURRENT_TIME__FORMAT:
				return getFormat();
		}
