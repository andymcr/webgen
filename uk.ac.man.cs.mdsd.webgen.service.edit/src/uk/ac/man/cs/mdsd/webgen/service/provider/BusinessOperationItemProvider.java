...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.service.BusinessOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BusinessOperationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenServicePackage.Literals.BUSINESS_OPERATION__USES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenServicePackage.Literals.BUSINESS_OPERATION__RESULT_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenServicePackage.Literals.BUSINESS_OPERATION__RESULT_MIME_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		OperationResultTypes labelValue = ((BusinessOperation)object).getResultType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BusinessOperation.class)) {
			...
			case WebGenServicePackage.BUSINESS_OPERATION__RESULT_MIME_TYPE:
