 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getSelectionType <em>Selection Type</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getContentType <em>Content Type</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getContainingFeature <em>Containing Feature</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getSelection <em>Selection</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getFilters <em>Filters</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getEmptyMessage <em>Empty Message</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getPagination <em>Pagination</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getDefaultPaginationSize <em>Default Pagination Size</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getNextNpages <em>Next Npages</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getPreviousNpages <em>Previous Npages</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getNextPageLabel <em>Next Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getPreviousPageLabel <em>Previous Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#isUseDisabledPageLinks <em>Use Disabled Page Links</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#isUseFirstLastPageLinks <em>Use First Last Page Links</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getFirstPageLabel <em>First Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getLastPageLabel <em>Last Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getDefaultSelection <em>Default Selection</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getImagePathFeature <em>Image Path Feature</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getTitleFeature <em>Title Feature</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getMissingImagePath <em>Missing Image Path</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getImageFilter <em>Image Filter</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getShowTime <em>Show Time</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.ImageUnitImpl#getTransitionTime <em>Transition Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ImageUnitImpl extends DynamicUnitImpl implements ImageUnit {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.IMAGE_UNIT;
	}
		...
		if (selectionType != null && selectionType.eIsProxy()) {
			...
			if (selectionType != oldSelectionType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.IMAGE_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
			}
		}
	...
	public void setSelectionType(EntityOrView newSelectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__SELECTION_TYPE, oldSelectionType, selectionType));
	}
	...
	public EList<EntityOrView> getContentType() {
		if (contentType == null) {
			contentType = new EObjectResolvingEList<EntityOrView>(EntityOrView.class, this, WebGenInterfacePackage.IMAGE_UNIT__CONTENT_TYPE);
		}
		return contentType;
	}
	...
	public Association getContainingFeature() {
		if (containingFeature != null && containingFeature.eIsProxy()) {
			...
			if (containingFeature != oldContainingFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.IMAGE_UNIT__CONTAINING_FEATURE, oldContainingFeature, containingFeature));
			}
		}
	...
	public void setContainingFeature(Association newContainingFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__CONTAINING_FEATURE, oldContainingFeature, containingFeature));
	}
	...
	public Selection getSelection() {
		if (selection != null && selection.eIsProxy()) {
			...
			if (selection != oldSelection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.IMAGE_UNIT__SELECTION, oldSelection, selection));
			}
		}
		return selection;
	}
	...
	public void setSelection(Selection newSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__SELECTION, oldSelection, selection));
	}
	...
	public EList<Filter> getFilters() {
		if (filters == null) {
			filters = new EObjectContainmentEList<Filter>(Filter.class, this, WebGenInterfacePackage.IMAGE_UNIT__FILTERS);
		}
		return filters;
	}
	...
	public void setEmptyMessage(String newEmptyMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__EMPTY_MESSAGE, oldEmptyMessage, emptyMessage));
	}
	...
	public Filter getPagination() {
		if (pagination != null && pagination.eIsProxy()) {
			...
			if (pagination != oldPagination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.IMAGE_UNIT__PAGINATION, oldPagination, pagination));
			}
		}
		return pagination;
	}
	...
	public void setPagination(Filter newPagination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__PAGINATION, oldPagination, pagination));
	}
	...
	public void setDefaultPaginationSize(int newDefaultPaginationSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__DEFAULT_PAGINATION_SIZE, oldDefaultPaginationSize, defaultPaginationSize));
	}
	...
	public void setNextNpages(int newNextNpages) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__NEXT_NPAGES, oldNextNpages, nextNpages));
	}
	...
	public void setPreviousNpages(int newPreviousNpages) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__PREVIOUS_NPAGES, oldPreviousNpages, previousNpages));
	}
	...
	public void setNextPageLabel(String newNextPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__NEXT_PAGE_LABEL, oldNextPageLabel, nextPageLabel));
	}
	...
	public void setPreviousPageLabel(String newPreviousPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__PREVIOUS_PAGE_LABEL, oldPreviousPageLabel, previousPageLabel));
	}
	...
	public void setUseDisabledPageLinks(boolean newUseDisabledPageLinks) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__USE_DISABLED_PAGE_LINKS, oldUseDisabledPageLinks, useDisabledPageLinks));
	}
	...
	public void setUseFirstLastPageLinks(boolean newUseFirstLastPageLinks) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__USE_FIRST_LAST_PAGE_LINKS, oldUseFirstLastPageLinks, useFirstLastPageLinks));
	}
	...
	public void setFirstPageLabel(String newFirstPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__FIRST_PAGE_LABEL, oldFirstPageLabel, firstPageLabel));
	}
	...
	public void setLastPageLabel(String newLastPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__LAST_PAGE_LABEL, oldLastPageLabel, lastPageLabel));
	}
	...
	public Selection getDefaultSelection() {
		if (defaultSelection != null && defaultSelection.eIsProxy()) {
			...
			if (defaultSelection != oldDefaultSelection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.IMAGE_UNIT__DEFAULT_SELECTION, oldDefaultSelection, defaultSelection));
			}
		}
	...
	public void setDefaultSelection(Selection newDefaultSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__DEFAULT_SELECTION, oldDefaultSelection, defaultSelection));
	}
	...
	public NotificationChain basicSetImagePathFeature(FeaturePath newImagePathFeature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__IMAGE_PATH_FEATURE, oldImagePathFeature, newImagePathFeature);
	...
	public void setImagePathFeature(FeaturePath newImagePathFeature) {
		if (newImagePathFeature != imagePathFeature) {
			...
			if (imagePathFeature != null)
				msgs = ((InternalEObject)imagePathFeature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.IMAGE_UNIT__IMAGE_PATH_FEATURE, null, msgs);
			if (newImagePathFeature != null)
				msgs = ((InternalEObject)newImagePathFeature).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.IMAGE_UNIT__IMAGE_PATH_FEATURE, null, msgs);
			msgs = basicSetImagePathFeature(newImagePathFeature, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__IMAGE_PATH_FEATURE, newImagePathFeature, newImagePathFeature));
	}
	...
	public NotificationChain basicSetTitleFeature(FeaturePath newTitleFeature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__TITLE_FEATURE, oldTitleFeature, newTitleFeature);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTitleFeature(FeaturePath newTitleFeature) {
		if (newTitleFeature != titleFeature) {
			...
			if (titleFeature != null)
				msgs = ((InternalEObject)titleFeature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.IMAGE_UNIT__TITLE_FEATURE, null, msgs);
			if (newTitleFeature != null)
				msgs = ((InternalEObject)newTitleFeature).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenInterfacePackage.IMAGE_UNIT__TITLE_FEATURE, null, msgs);
			msgs = basicSetTitleFeature(newTitleFeature, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__TITLE_FEATURE, newTitleFeature, newTitleFeature));
	}
	...
	public void setMissingImagePath(String newMissingImagePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__MISSING_IMAGE_PATH, oldMissingImagePath, missingImagePath));
	}
	...
	public ImageFilter getImageFilter() {
		if (imageFilter != null && imageFilter.eIsProxy()) {
			...
			imageFilter = (ImageFilter)eResolveProxy(oldImageFilter);
			if (imageFilter != oldImageFilter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.IMAGE_UNIT__IMAGE_FILTER, oldImageFilter, imageFilter));
			}
		}
		return imageFilter;
	}
	 ...
	 * @generated
	 */
	public ImageFilter basicGetImageFilter() {
		return imageFilter;
	}
	 ...
	 * @generated
	 */
	public void setImageFilter(ImageFilter newImageFilter) {
		ImageFilter oldImageFilter = imageFilter;
		imageFilter = newImageFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__IMAGE_FILTER, oldImageFilter, imageFilter));
	}
	...
	public void setShowTime(int newShowTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__SHOW_TIME, oldShowTime, showTime));
	}
	...
	public void setTransitionTime(int newTransitionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.IMAGE_UNIT__TRANSITION_TIME, oldTransitionTime, transitionTime));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenInterfacePackage.IMAGE_UNIT__FILTERS:
				return ((InternalEList<?>)getFilters()).basicRemove(otherEnd, msgs);
			case WebGenInterfacePackage.IMAGE_UNIT__IMAGE_PATH_FEATURE:
				return basicSetImagePathFeature(null, msgs);
			case WebGenInterfacePackage.IMAGE_UNIT__TITLE_FEATURE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.IMAGE_UNIT__SELECTION_TYPE:
				if (resolve) return getSelectionType();
				return basicGetSelectionType();
			case WebGenInterfacePackage.IMAGE_UNIT__CONTENT_TYPE:
				return getContentType();
			case WebGenInterfacePackage.IMAGE_UNIT__CONTAINING_FEATURE:
				if (resolve) return getContainingFeature();
				return basicGetContainingFeature();
			case WebGenInterfacePackage.IMAGE_UNIT__SELECTION:
				if (resolve) return getSelection();
				return basicGetSelection();
			case WebGenInterfacePackage.IMAGE_UNIT__FILTERS:
				return getFilters();
			case WebGenInterfacePackage.IMAGE_UNIT__EMPTY_MESSAGE:
				return getEmptyMessage();
			case WebGenInterfacePackage.IMAGE_UNIT__PAGINATION:
				if (resolve) return getPagination();
				return basicGetPagination();
			case WebGenInterfacePackage.IMAGE_UNIT__DEFAULT_PAGINATION_SIZE:
				return getDefaultPaginationSize();
			case WebGenInterfacePackage.IMAGE_UNIT__NEXT_NPAGES:
				return getNextNpages();
			case WebGenInterfacePackage.IMAGE_UNIT__PREVIOUS_NPAGES:
				return getPreviousNpages();
			case WebGenInterfacePackage.IMAGE_UNIT__NEXT_PAGE_LABEL:
				return getNextPageLabel();
			case WebGenInterfacePackage.IMAGE_UNIT__PREVIOUS_PAGE_LABEL:
				return getPreviousPageLabel();
			case WebGenInterfacePackage.IMAGE_UNIT__USE_DISABLED_PAGE_LINKS:
				return isUseDisabledPageLinks();
			case WebGenInterfacePackage.IMAGE_UNIT__USE_FIRST_LAST_PAGE_LINKS:
				return isUseFirstLastPageLinks();
			case WebGenInterfacePackage.IMAGE_UNIT__FIRST_PAGE_LABEL:
				return getFirstPageLabel();
			case WebGenInterfacePackage.IMAGE_UNIT__LAST_PAGE_LABEL:
				return getLastPageLabel();
			case WebGenInterfacePackage.IMAGE_UNIT__DEFAULT_SELECTION:
			...
			case WebGenInterfacePackage.IMAGE_UNIT__MISSING_IMAGE_PATH:
				return getMissingImagePath();
			case WebGenInterfacePackage.IMAGE_UNIT__IMAGE_FILTER:
				if (resolve) return getImageFilter();
				return basicGetImageFilter();
			case WebGenInterfacePackage.IMAGE_UNIT__SHOW_TIME:
				return getShowTime();
			case WebGenInterfacePackage.IMAGE_UNIT__TRANSITION_TIME:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case WebGenInterfacePackage.IMAGE_UNIT__MISSING_IMAGE_PATH:
				...
				return;
			case WebGenInterfacePackage.IMAGE_UNIT__IMAGE_FILTER:
				setImageFilter((ImageFilter)newValue);
				return;
			case WebGenInterfacePackage.IMAGE_UNIT__SHOW_TIME:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case WebGenInterfacePackage.IMAGE_UNIT__MISSING_IMAGE_PATH:
				...
				return;
			case WebGenInterfacePackage.IMAGE_UNIT__IMAGE_FILTER:
				setImageFilter((ImageFilter)null);
				return;
			case WebGenInterfacePackage.IMAGE_UNIT__SHOW_TIME:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SelectableUnit.class) {
			switch (derivedFeatureID) {
				case WebGenInterfacePackage.IMAGE_UNIT__SELECTION_TYPE: return WebGenInterfacePackage.SELECTABLE_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
		if (baseClass == CollectionUnit.class) {
			switch (derivedFeatureID) {
				case WebGenInterfacePackage.IMAGE_UNIT__CONTENT_TYPE: return WebGenInterfacePackage.COLLECTION_UNIT__CONTENT_TYPE;
				case WebGenInterfacePackage.IMAGE_UNIT__CONTAINING_FEATURE: return WebGenInterfacePackage.COLLECTION_UNIT__CONTAINING_FEATURE;
				case WebGenInterfacePackage.IMAGE_UNIT__SELECTION: return WebGenInterfacePackage.COLLECTION_UNIT__SELECTION;
				case WebGenInterfacePackage.IMAGE_UNIT__FILTERS: return WebGenInterfacePackage.COLLECTION_UNIT__FILTERS;
				case WebGenInterfacePackage.IMAGE_UNIT__EMPTY_MESSAGE: return WebGenInterfacePackage.COLLECTION_UNIT__EMPTY_MESSAGE;
				case WebGenInterfacePackage.IMAGE_UNIT__PAGINATION: return WebGenInterfacePackage.COLLECTION_UNIT__PAGINATION;
				case WebGenInterfacePackage.IMAGE_UNIT__DEFAULT_PAGINATION_SIZE: return WebGenInterfacePackage.COLLECTION_UNIT__DEFAULT_PAGINATION_SIZE;
				case WebGenInterfacePackage.IMAGE_UNIT__NEXT_NPAGES: return WebGenInterfacePackage.COLLECTION_UNIT__NEXT_NPAGES;
				case WebGenInterfacePackage.IMAGE_UNIT__PREVIOUS_NPAGES: return WebGenInterfacePackage.COLLECTION_UNIT__PREVIOUS_NPAGES;
				case WebGenInterfacePackage.IMAGE_UNIT__NEXT_PAGE_LABEL: return WebGenInterfacePackage.COLLECTION_UNIT__NEXT_PAGE_LABEL;
				case WebGenInterfacePackage.IMAGE_UNIT__PREVIOUS_PAGE_LABEL: return WebGenInterfacePackage.COLLECTION_UNIT__PREVIOUS_PAGE_LABEL;
				case WebGenInterfacePackage.IMAGE_UNIT__USE_DISABLED_PAGE_LINKS: return WebGenInterfacePackage.COLLECTION_UNIT__USE_DISABLED_PAGE_LINKS;
				case WebGenInterfacePackage.IMAGE_UNIT__USE_FIRST_LAST_PAGE_LINKS: return WebGenInterfacePackage.COLLECTION_UNIT__USE_FIRST_LAST_PAGE_LINKS;
				case WebGenInterfacePackage.IMAGE_UNIT__FIRST_PAGE_LABEL: return WebGenInterfacePackage.COLLECTION_UNIT__FIRST_PAGE_LABEL;
				case WebGenInterfacePackage.IMAGE_UNIT__LAST_PAGE_LABEL: return WebGenInterfacePackage.COLLECTION_UNIT__LAST_PAGE_LABEL;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SelectableUnit.class) {
			switch (baseFeatureID) {
				case WebGenInterfacePackage.SELECTABLE_UNIT__SELECTION_TYPE: return WebGenInterfacePackage.IMAGE_UNIT__SELECTION_TYPE;
				default: return -1;
			}
		}
		if (baseClass == CollectionUnit.class) {
			switch (baseFeatureID) {
				case WebGenInterfacePackage.COLLECTION_UNIT__CONTENT_TYPE: return WebGenInterfacePackage.IMAGE_UNIT__CONTENT_TYPE;
				case WebGenInterfacePackage.COLLECTION_UNIT__CONTAINING_FEATURE: return WebGenInterfacePackage.IMAGE_UNIT__CONTAINING_FEATURE;
				case WebGenInterfacePackage.COLLECTION_UNIT__SELECTION: return WebGenInterfacePackage.IMAGE_UNIT__SELECTION;
				case WebGenInterfacePackage.COLLECTION_UNIT__FILTERS: return WebGenInterfacePackage.IMAGE_UNIT__FILTERS;
				case WebGenInterfacePackage.COLLECTION_UNIT__EMPTY_MESSAGE: return WebGenInterfacePackage.IMAGE_UNIT__EMPTY_MESSAGE;
				case WebGenInterfacePackage.COLLECTION_UNIT__PAGINATION: return WebGenInterfacePackage.IMAGE_UNIT__PAGINATION;
				case WebGenInterfacePackage.COLLECTION_UNIT__DEFAULT_PAGINATION_SIZE: return WebGenInterfacePackage.IMAGE_UNIT__DEFAULT_PAGINATION_SIZE;
				case WebGenInterfacePackage.COLLECTION_UNIT__NEXT_NPAGES: return WebGenInterfacePackage.IMAGE_UNIT__NEXT_NPAGES;
				case WebGenInterfacePackage.COLLECTION_UNIT__PREVIOUS_NPAGES: return WebGenInterfacePackage.IMAGE_UNIT__PREVIOUS_NPAGES;
				case WebGenInterfacePackage.COLLECTION_UNIT__NEXT_PAGE_LABEL: return WebGenInterfacePackage.IMAGE_UNIT__NEXT_PAGE_LABEL;
				case WebGenInterfacePackage.COLLECTION_UNIT__PREVIOUS_PAGE_LABEL: return WebGenInterfacePackage.IMAGE_UNIT__PREVIOUS_PAGE_LABEL;
				case WebGenInterfacePackage.COLLECTION_UNIT__USE_DISABLED_PAGE_LINKS: return WebGenInterfacePackage.IMAGE_UNIT__USE_DISABLED_PAGE_LINKS;
				case WebGenInterfacePackage.COLLECTION_UNIT__USE_FIRST_LAST_PAGE_LINKS: return WebGenInterfacePackage.IMAGE_UNIT__USE_FIRST_LAST_PAGE_LINKS;
				case WebGenInterfacePackage.COLLECTION_UNIT__FIRST_PAGE_LABEL: return WebGenInterfacePackage.IMAGE_UNIT__FIRST_PAGE_LABEL;
				case WebGenInterfacePackage.COLLECTION_UNIT__LAST_PAGE_LABEL: return WebGenInterfacePackage.IMAGE_UNIT__LAST_PAGE_LABEL;
				default: return -1;
			}
		}
