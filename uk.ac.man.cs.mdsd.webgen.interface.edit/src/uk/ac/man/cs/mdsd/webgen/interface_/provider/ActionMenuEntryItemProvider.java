...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.interface_.ActionMenuEntry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionMenuEntryItemProvider extends MenuEntryItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenInterfacePackage.Literals.ACTION_MENU_ENTRY__DESTINATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebGenInterfacePackage.Literals.ACTION_MENU_ENTRY__QUERY);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ActionMenuEntry.class)) {
			case WebGenInterfacePackage.ACTION_MENU_ENTRY__NAME:
			case WebGenInterfacePackage.ACTION_MENU_ENTRY__DISPLAY_LABEL:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case WebGenInterfacePackage.ACTION_MENU_ENTRY__QUERY:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebGenInterfacePackage.Literals.ACTION_MENU_ENTRY__QUERY,
				 WebGenInterfaceFactory.eINSTANCE.createQuery()));
	}
