...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.service.ParameterReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterReference_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterReference_name_feature", "_UI_ParameterReference_type"),
				 WebGenServicePackage.Literals.PARAMETER_REFERENCE__NAME,
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenServicePackage.Literals.PARAMETER_REFERENCE__PARAMETER,
				 true,
				 false,
				 true,
				 null,
