...
public class QueryImpl extends MinimalEObjectImpl.Container implements Query {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.QUERY;
	}
		...
		if (filter != null && filter.eIsProxy()) {
			...
			if (filter != oldFilter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.QUERY__FILTER, oldFilter, filter));
			}
		}
		return filter;
	}
	...
	public void setFilter(Filter newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.QUERY__FILTER, oldFilter, filter));
	}
	...
	public EList<QueryParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<QueryParameter>(QueryParameter.class, this, WebGenWebUIPackage.QUERY__PARAMETERS);
		}
		return parameters;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.QUERY__PARAMETERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.QUERY__FILTER:
