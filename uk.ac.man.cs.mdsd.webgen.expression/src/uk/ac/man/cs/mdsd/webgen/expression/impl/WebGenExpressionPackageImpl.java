...
import uk.ac.man.cs.mdsd.webgen.expression.BooleanLiteral;
 ...
 * @generated
 */
public class WebGenExpressionPackageImpl extends EPackageImpl implements WebGenExpressionPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.expression.WebGenExpressionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private WebGenExpressionPackageImpl() {
		super(eNS_URI, WebGenExpressionFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link WebGenExpressionPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static WebGenExpressionPackage init() {
		if (isInited) return (WebGenExpressionPackage)EPackage.Registry.INSTANCE.getEPackage(WebGenExpressionPackage.eNS_URI);

		// Obtain or create and register package
		WebGenExpressionPackageImpl theWebGenExpressionPackage = (WebGenExpressionPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof WebGenExpressionPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new WebGenExpressionPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theWebGenExpressionPackage.createPackageContents();

		// Initialize created meta-data
		theWebGenExpressionPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theWebGenExpressionPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(WebGenExpressionPackage.eNS_URI, theWebGenExpressionPackage);
		return theWebGenExpressionPackage;
	}
	 ...
	 * @generated
	 */
	public WebGenExpressionFactory getWebGenExpressionFactory() {
		return (WebGenExpressionFactory)getEFactoryInstance();
	}
