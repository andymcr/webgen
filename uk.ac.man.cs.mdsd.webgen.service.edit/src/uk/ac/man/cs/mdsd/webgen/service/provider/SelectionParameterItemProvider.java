...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.service.SelectionParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SelectionParameterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenServicePackage.Literals.SELECTION_PARAMETER__OPTIONAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebGenServicePackage.Literals.SELECTION_PARAMETER__DEFAULT_VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		SelectionParameter selectionParameter = (SelectionParameter)object;
		return getString("_UI_SelectionParameter_type") + " " + selectionParameter.isOptional();
	}
