 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getAlternative <em>Alternative</em>}</li>
 ...
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getHeaderClass <em>Header Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getControlClass <em>Control Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getFooterClass <em>Footer Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getErrorClass <em>Error Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getSubmitLabel <em>Submit Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getCancelDestination <em>Cancel Destination</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getCancelLabel <em>Cancel Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getContentClass <em>Content Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getLogoutUriElement <em>Logout Uri Element</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.LoginUnitImpl#getStyleClass <em>Style Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoginUnitImpl extends MinimalEObjectImpl.Container implements LoginUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.LOGIN_UNIT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__NAME, oldName, name));
	}
	...
	public void setDisplayLabel(String newDisplayLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__DISPLAY_LABEL, oldDisplayLabel, displayLabel));
	}
	...
	public UnitContainer getDisplayedOn() {
		if (eContainerFeatureID() != WebGenWebUIPackage.LOGIN_UNIT__DISPLAYED_ON) return null;
	...
	public NotificationChain basicSetDisplayedOn(UnitContainer newDisplayedOn, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDisplayedOn, WebGenWebUIPackage.LOGIN_UNIT__DISPLAYED_ON, msgs);
		return msgs;
	}
	...
	public void setDisplayedOn(UnitContainer newDisplayedOn) {
		if (newDisplayedOn != eInternalContainer() || (eContainerFeatureID() != WebGenWebUIPackage.LOGIN_UNIT__DISPLAYED_ON && newDisplayedOn != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__DISPLAYED_ON, newDisplayedOn, newDisplayedOn));
	}
	...
	public void setCreateDefaultUriElement(boolean newCreateDefaultUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__CREATE_DEFAULT_URI_ELEMENT, oldCreateDefaultUriElement, createDefaultUriElement));
	}
	...
	public void setRequiresRole(String newRequiresRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__REQUIRES_ROLE, oldRequiresRole, requiresRole));
	}
	...
	public void setPurposeSummary(String newPurposeSummary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__PURPOSE_SUMMARY, oldPurposeSummary, purposeSummary));
	}
	...
	public void setUriElement(String newUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__URI_ELEMENT, oldUriElement, uriElement));
	}
	...
	public void setAlternative(String newAlternative) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__ALTERNATIVE, oldAlternative, alternative));
	}
	...
	public void setOmitCaption(boolean newOmitCaption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__OMIT_CAPTION, oldOmitCaption, omitCaption));
	}
	...
	public void setCaptionClass(String newCaptionClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__CAPTION_CLASS, oldCaptionClass, captionClass));
	}
	...
	public EList<EntityOrView> getEntities() {
		if (entities == null) {
			entities = new EObjectResolvingEList<EntityOrView>(EntityOrView.class, this, WebGenWebUIPackage.LOGIN_UNIT__ENTITIES);
		}
		return entities;
	}
	...
	public EList<UnitField> getDisplayFields() {
		if (displayFields == null) {
			displayFields = new EObjectContainmentWithInverseEList<UnitField>(UnitField.class, this, WebGenWebUIPackage.LOGIN_UNIT__DISPLAY_FIELDS, WebGenWebUIPackage.UNIT_FIELD__DISPLAYED_ON);
		}
	...
	public EList<UnitSupportAction> getSupportActions() {
		if (supportActions == null) {
			supportActions = new EObjectContainmentEList<UnitSupportAction>(UnitSupportAction.class, this, WebGenWebUIPackage.LOGIN_UNIT__SUPPORT_ACTIONS);
		}
	...
	public void setHeader(String newHeader) {
		...
		header = newHeader;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__HEADER, oldHeader, header));
	}
	...
	public void setFooter(String newFooter) {
		...
		footer = newFooter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__FOOTER, oldFooter, footer));
	}
	...
	public void setHeaderClass(String newHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__HEADER_CLASS, oldHeaderClass, headerClass));
	}
	...
	public void setControlClass(String newControlClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__CONTROL_CLASS, oldControlClass, controlClass));
	}
	...
	public void setFooterClass(String newFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__FOOTER_CLASS, oldFooterClass, footerClass));
	}
	...
	public void setErrorClass(String newErrorClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__ERROR_CLASS, oldErrorClass, errorClass));
	}
	...
	public void setSubmitLabel(String newSubmitLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__SUBMIT_LABEL, oldSubmitLabel, submitLabel));
	}
	...
	public Page getCancelDestination() {
		if (cancelDestination != null && cancelDestination.eIsProxy()) {
			...
			if (cancelDestination != oldCancelDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenWebUIPackage.LOGIN_UNIT__CANCEL_DESTINATION, oldCancelDestination, cancelDestination));
			}
		}
	...
	public void setCancelDestination(Page newCancelDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__CANCEL_DESTINATION, oldCancelDestination, cancelDestination));
	}
	...
	public void setCancelLabel(String newCancelLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__CANCEL_LABEL, oldCancelLabel, cancelLabel));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public void setLogoutUriElement(String newLogoutUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__LOGOUT_URI_ELEMENT, oldLogoutUriElement, logoutUriElement));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.LOGIN_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.LOGIN_UNIT__DISPLAYED_ON:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetDisplayedOn((UnitContainer)otherEnd, msgs);
			case WebGenWebUIPackage.LOGIN_UNIT__DISPLAY_FIELDS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WebGenWebUIPackage.LOGIN_UNIT__SUPPORT_ACTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.LOGIN_UNIT__NAME:
				return getName();
			case WebGenWebUIPackage.LOGIN_UNIT__DISPLAY_LABEL:
				return getDisplayLabel();
			case WebGenWebUIPackage.LOGIN_UNIT__DISPLAYED_ON:
				return getDisplayedOn();
			case WebGenWebUIPackage.LOGIN_UNIT__CREATE_DEFAULT_URI_ELEMENT:
				return isCreateDefaultUriElement();
			case WebGenWebUIPackage.LOGIN_UNIT__REQUIRES_ROLE:
				return getRequiresRole();
			case WebGenWebUIPackage.LOGIN_UNIT__PURPOSE_SUMMARY:
				return getPurposeSummary();
			case WebGenWebUIPackage.LOGIN_UNIT__URI_ELEMENT:
				return getUriElement();
			case WebGenWebUIPackage.LOGIN_UNIT__ALTERNATIVE:
				return getAlternative();
			case WebGenWebUIPackage.LOGIN_UNIT__OMIT_CAPTION:
				return isOmitCaption();
			case WebGenWebUIPackage.LOGIN_UNIT__CAPTION_CLASS:
				return getCaptionClass();
			case WebGenWebUIPackage.LOGIN_UNIT__ENTITIES:
				return getEntities();
			case WebGenWebUIPackage.LOGIN_UNIT__DISPLAY_FIELDS:
				return getDisplayFields();
			case WebGenWebUIPackage.LOGIN_UNIT__SUPPORT_ACTIONS:
				return getSupportActions();
			case WebGenWebUIPackage.LOGIN_UNIT__HEADER:
				return getHeader();
			case WebGenWebUIPackage.LOGIN_UNIT__FOOTER:
				return getFooter();
			case WebGenWebUIPackage.LOGIN_UNIT__HEADER_CLASS:
				return getHeaderClass();
			case WebGenWebUIPackage.LOGIN_UNIT__CONTROL_CLASS:
				return getControlClass();
			case WebGenWebUIPackage.LOGIN_UNIT__FOOTER_CLASS:
				return getFooterClass();
			case WebGenWebUIPackage.LOGIN_UNIT__ERROR_CLASS:
				return getErrorClass();
			case WebGenWebUIPackage.LOGIN_UNIT__SUBMIT_LABEL:
				return getSubmitLabel();
			case WebGenWebUIPackage.LOGIN_UNIT__CANCEL_DESTINATION:
				if (resolve) return getCancelDestination();
				return basicGetCancelDestination();
			case WebGenWebUIPackage.LOGIN_UNIT__CANCEL_LABEL:
				return getCancelLabel();
			case WebGenWebUIPackage.LOGIN_UNIT__CONTENT_CLASS:
				return getContentClass();
			case WebGenWebUIPackage.LOGIN_UNIT__LOGOUT_URI_ELEMENT:
				return getLogoutUriElement();
			case WebGenWebUIPackage.LOGIN_UNIT__STYLE_CLASS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.LOGIN_UNIT__NAME: return WebGenCorePackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == NamedDisplayElement.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.LOGIN_UNIT__DISPLAY_LABEL: return WebGenCorePackage.NAMED_DISPLAY_ELEMENT__DISPLAY_LABEL;
				default: return -1;
			}
		}
		if (baseClass == ContentUnit.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.LOGIN_UNIT__DISPLAYED_ON: return WebGenWebUIPackage.CONTENT_UNIT__DISPLAYED_ON;
				case WebGenWebUIPackage.LOGIN_UNIT__CREATE_DEFAULT_URI_ELEMENT: return WebGenWebUIPackage.CONTENT_UNIT__CREATE_DEFAULT_URI_ELEMENT;
				case WebGenWebUIPackage.LOGIN_UNIT__REQUIRES_ROLE: return WebGenWebUIPackage.CONTENT_UNIT__REQUIRES_ROLE;
				case WebGenWebUIPackage.LOGIN_UNIT__PURPOSE_SUMMARY: return WebGenWebUIPackage.CONTENT_UNIT__PURPOSE_SUMMARY;
				case WebGenWebUIPackage.LOGIN_UNIT__URI_ELEMENT: return WebGenWebUIPackage.CONTENT_UNIT__URI_ELEMENT;
				case WebGenWebUIPackage.LOGIN_UNIT__ALTERNATIVE: return WebGenWebUIPackage.CONTENT_UNIT__ALTERNATIVE;
				case WebGenWebUIPackage.LOGIN_UNIT__OMIT_CAPTION: return WebGenWebUIPackage.CONTENT_UNIT__OMIT_CAPTION;
				case WebGenWebUIPackage.LOGIN_UNIT__CAPTION_CLASS: return WebGenWebUIPackage.CONTENT_UNIT__CAPTION_CLASS;
				default: return -1;
			}
		}
		if (baseClass == DynamicUnit.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.LOGIN_UNIT__ENTITIES: return WebGenWebUIPackage.DYNAMIC_UNIT__ENTITIES;
				case WebGenWebUIPackage.LOGIN_UNIT__DISPLAY_FIELDS: return WebGenWebUIPackage.DYNAMIC_UNIT__DISPLAY_FIELDS;
				case WebGenWebUIPackage.LOGIN_UNIT__SUPPORT_ACTIONS: return WebGenWebUIPackage.DYNAMIC_UNIT__SUPPORT_ACTIONS;
				case WebGenWebUIPackage.LOGIN_UNIT__HEADER: return WebGenWebUIPackage.DYNAMIC_UNIT__HEADER;
				case WebGenWebUIPackage.LOGIN_UNIT__FOOTER: return WebGenWebUIPackage.DYNAMIC_UNIT__FOOTER;
				case WebGenWebUIPackage.LOGIN_UNIT__HEADER_CLASS: return WebGenWebUIPackage.DYNAMIC_UNIT__HEADER_CLASS;
				case WebGenWebUIPackage.LOGIN_UNIT__CONTROL_CLASS: return WebGenWebUIPackage.DYNAMIC_UNIT__CONTROL_CLASS;
				case WebGenWebUIPackage.LOGIN_UNIT__FOOTER_CLASS: return WebGenWebUIPackage.DYNAMIC_UNIT__FOOTER_CLASS;
				case WebGenWebUIPackage.LOGIN_UNIT__ERROR_CLASS: return WebGenWebUIPackage.DYNAMIC_UNIT__ERROR_CLASS;
				default: return -1;
			}
		}
		if (baseClass == ControlUnit.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.LOGIN_UNIT__SUBMIT_LABEL: return WebGenWebUIPackage.CONTROL_UNIT__SUBMIT_LABEL;
				case WebGenWebUIPackage.LOGIN_UNIT__CANCEL_DESTINATION: return WebGenWebUIPackage.CONTROL_UNIT__CANCEL_DESTINATION;
				case WebGenWebUIPackage.LOGIN_UNIT__CANCEL_LABEL: return WebGenWebUIPackage.CONTROL_UNIT__CANCEL_LABEL;
				case WebGenWebUIPackage.LOGIN_UNIT__CONTENT_CLASS: return WebGenWebUIPackage.CONTROL_UNIT__CONTENT_CLASS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case WebGenCorePackage.NAMED_ELEMENT__NAME: return WebGenWebUIPackage.LOGIN_UNIT__NAME;
				default: return -1;
			}
		}
		if (baseClass == NamedDisplayElement.class) {
			switch (baseFeatureID) {
				case WebGenCorePackage.NAMED_DISPLAY_ELEMENT__DISPLAY_LABEL: return WebGenWebUIPackage.LOGIN_UNIT__DISPLAY_LABEL;
				default: return -1;
			}
		}
		if (baseClass == ContentUnit.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.CONTENT_UNIT__DISPLAYED_ON: return WebGenWebUIPackage.LOGIN_UNIT__DISPLAYED_ON;
				case WebGenWebUIPackage.CONTENT_UNIT__CREATE_DEFAULT_URI_ELEMENT: return WebGenWebUIPackage.LOGIN_UNIT__CREATE_DEFAULT_URI_ELEMENT;
				case WebGenWebUIPackage.CONTENT_UNIT__REQUIRES_ROLE: return WebGenWebUIPackage.LOGIN_UNIT__REQUIRES_ROLE;
				case WebGenWebUIPackage.CONTENT_UNIT__PURPOSE_SUMMARY: return WebGenWebUIPackage.LOGIN_UNIT__PURPOSE_SUMMARY;
				case WebGenWebUIPackage.CONTENT_UNIT__URI_ELEMENT: return WebGenWebUIPackage.LOGIN_UNIT__URI_ELEMENT;
				case WebGenWebUIPackage.CONTENT_UNIT__ALTERNATIVE: return WebGenWebUIPackage.LOGIN_UNIT__ALTERNATIVE;
				case WebGenWebUIPackage.CONTENT_UNIT__OMIT_CAPTION: return WebGenWebUIPackage.LOGIN_UNIT__OMIT_CAPTION;
				case WebGenWebUIPackage.CONTENT_UNIT__CAPTION_CLASS: return WebGenWebUIPackage.LOGIN_UNIT__CAPTION_CLASS;
				default: return -1;
			}
		}
		if (baseClass == DynamicUnit.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.DYNAMIC_UNIT__ENTITIES: return WebGenWebUIPackage.LOGIN_UNIT__ENTITIES;
				case WebGenWebUIPackage.DYNAMIC_UNIT__DISPLAY_FIELDS: return WebGenWebUIPackage.LOGIN_UNIT__DISPLAY_FIELDS;
				case WebGenWebUIPackage.DYNAMIC_UNIT__SUPPORT_ACTIONS: return WebGenWebUIPackage.LOGIN_UNIT__SUPPORT_ACTIONS;
				case WebGenWebUIPackage.DYNAMIC_UNIT__HEADER: return WebGenWebUIPackage.LOGIN_UNIT__HEADER;
				case WebGenWebUIPackage.DYNAMIC_UNIT__FOOTER: return WebGenWebUIPackage.LOGIN_UNIT__FOOTER;
				case WebGenWebUIPackage.DYNAMIC_UNIT__HEADER_CLASS: return WebGenWebUIPackage.LOGIN_UNIT__HEADER_CLASS;
				case WebGenWebUIPackage.DYNAMIC_UNIT__CONTROL_CLASS: return WebGenWebUIPackage.LOGIN_UNIT__CONTROL_CLASS;
				case WebGenWebUIPackage.DYNAMIC_UNIT__FOOTER_CLASS: return WebGenWebUIPackage.LOGIN_UNIT__FOOTER_CLASS;
				case WebGenWebUIPackage.DYNAMIC_UNIT__ERROR_CLASS: return WebGenWebUIPackage.LOGIN_UNIT__ERROR_CLASS;
				default: return -1;
			}
		}
		if (baseClass == ControlUnit.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.CONTROL_UNIT__SUBMIT_LABEL: return WebGenWebUIPackage.LOGIN_UNIT__SUBMIT_LABEL;
				case WebGenWebUIPackage.CONTROL_UNIT__CANCEL_DESTINATION: return WebGenWebUIPackage.LOGIN_UNIT__CANCEL_DESTINATION;
				case WebGenWebUIPackage.CONTROL_UNIT__CANCEL_LABEL: return WebGenWebUIPackage.LOGIN_UNIT__CANCEL_LABEL;
				case WebGenWebUIPackage.CONTROL_UNIT__CONTENT_CLASS: return WebGenWebUIPackage.LOGIN_UNIT__CONTENT_CLASS;
				default: return -1;
			}
		}
