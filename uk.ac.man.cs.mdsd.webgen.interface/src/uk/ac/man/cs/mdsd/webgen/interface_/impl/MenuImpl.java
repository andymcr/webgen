 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.MenuImpl#getEntries <em>Entries</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.MenuImpl#isOmitCaption <em>Omit Caption</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.MenuImpl#getCaptionClass <em>Caption Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.MenuImpl#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.MenuImpl#getLayoutClass <em>Layout Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MenuImpl extends NamedDisplayElementImpl implements Menu {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.MENU;
	}
	...
	public EList<MenuEntry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentWithInverseEList<MenuEntry>(MenuEntry.class, this, WebGenInterfacePackage.MENU__ENTRIES, WebGenInterfacePackage.MENU_ENTRY__PART_OF);
		}
		return entries;
	}
	...
	public void setOmitCaption(boolean newOmitCaption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.MENU__OMIT_CAPTION, oldOmitCaption, omitCaption));
	}
	...
	public void setCaptionClass(String newCaptionClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.MENU__CAPTION_CLASS, oldCaptionClass, captionClass));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.MENU__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setLayoutClass(String newLayoutClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.MENU__LAYOUT_CLASS, oldLayoutClass, layoutClass));
	}
