...
public abstract class ContentUnitImpl extends NamedDisplayElementImpl implements ContentUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.CONTENT_UNIT;
	}
	...
	public UnitContainer getDisplayedOn() {
		if (eContainerFeatureID() != WebGenWebUIPackage.CONTENT_UNIT__DISPLAYED_ON) return null;
	...
	public NotificationChain basicSetDisplayedOn(UnitContainer newDisplayedOn, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDisplayedOn, WebGenWebUIPackage.CONTENT_UNIT__DISPLAYED_ON, msgs);
		return msgs;
	}
	...
	public void setDisplayedOn(UnitContainer newDisplayedOn) {
		if (newDisplayedOn != eInternalContainer() || (eContainerFeatureID() != WebGenWebUIPackage.CONTENT_UNIT__DISPLAYED_ON && newDisplayedOn != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CONTENT_UNIT__DISPLAYED_ON, newDisplayedOn, newDisplayedOn));
	}
	...
	public void setCreateDefaultUriElement(boolean newCreateDefaultUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CONTENT_UNIT__CREATE_DEFAULT_URI_ELEMENT, oldCreateDefaultUriElement, createDefaultUriElement));
	}
	...
	public void setRequiresRole(String newRequiresRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CONTENT_UNIT__REQUIRES_ROLE, oldRequiresRole, requiresRole));
	}
	...
	public void setPurposeSummary(String newPurposeSummary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CONTENT_UNIT__PURPOSE_SUMMARY, oldPurposeSummary, purposeSummary));
	}
	...
	public void setUriElement(String newUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CONTENT_UNIT__URI_ELEMENT, oldUriElement, uriElement));
	}
	...
	public void setAlternative(String newAlternative) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CONTENT_UNIT__ALTERNATIVE, oldAlternative, alternative));
	}
	...
	public void setOmitCaption(boolean newOmitCaption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CONTENT_UNIT__OMIT_CAPTION, oldOmitCaption, omitCaption));
	}
	...
	public void setCaptionClass(String newCaptionClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.CONTENT_UNIT__CAPTION_CLASS, oldCaptionClass, captionClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.CONTENT_UNIT__DISPLAYED_ON:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WebGenWebUIPackage.CONTENT_UNIT__CREATE_DEFAULT_URI_ELEMENT:
				return isCreateDefaultUriElement();
			case WebGenWebUIPackage.CONTENT_UNIT__REQUIRES_ROLE:
				return getRequiresRole();
			case WebGenWebUIPackage.CONTENT_UNIT__PURPOSE_SUMMARY:
				return getPurposeSummary();
			case WebGenWebUIPackage.CONTENT_UNIT__URI_ELEMENT:
				return getUriElement();
			case WebGenWebUIPackage.CONTENT_UNIT__ALTERNATIVE:
				return getAlternative();
			case WebGenWebUIPackage.CONTENT_UNIT__OMIT_CAPTION:
				return isOmitCaption();
			case WebGenWebUIPackage.CONTENT_UNIT__CAPTION_CLASS:
