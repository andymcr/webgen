 ...
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.DynamicUnitImpl#getFooter <em>Footer</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.DynamicUnitImpl#getHeaderClass <em>Header Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.DynamicUnitImpl#getControlClass <em>Control Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.DynamicUnitImpl#getFooterClass <em>Footer Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.DynamicUnitImpl#getErrorClass <em>Error Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DynamicUnitImpl extends ContentUnitImpl implements DynamicUnit {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.DYNAMIC_UNIT;
	}
	...
	public EList<EntityOrView> getEntities() {
		if (entities == null) {
			entities = new EObjectResolvingEList<EntityOrView>(EntityOrView.class, this, WebGenWebUIPackage.DYNAMIC_UNIT__ENTITIES);
		}
		return entities;
	}
	...
	public EList<UnitField> getDisplayFields() {
		if (displayFields == null) {
			displayFields = new EObjectContainmentWithInverseEList<UnitField>(UnitField.class, this, WebGenWebUIPackage.DYNAMIC_UNIT__DISPLAY_FIELDS, WebGenWebUIPackage.UNIT_FIELD__DISPLAYED_ON);
		}
	...
	public EList<UnitSupportAction> getSupportActions() {
		if (supportActions == null) {
			supportActions = new EObjectContainmentEList<UnitSupportAction>(UnitSupportAction.class, this, WebGenWebUIPackage.DYNAMIC_UNIT__SUPPORT_ACTIONS);
		}
	...
	public void setHeader(String newHeader) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DYNAMIC_UNIT__HEADER, oldHeader, header));
	}
	...
	public void setFooter(String newFooter) {
		...
		footer = newFooter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DYNAMIC_UNIT__FOOTER, oldFooter, footer));
	}
	...
	public void setHeaderClass(String newHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DYNAMIC_UNIT__HEADER_CLASS, oldHeaderClass, headerClass));
	}
	...
	public void setControlClass(String newControlClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DYNAMIC_UNIT__CONTROL_CLASS, oldControlClass, controlClass));
	}
	...
	public void setFooterClass(String newFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DYNAMIC_UNIT__FOOTER_CLASS, oldFooterClass, footerClass));
	}
	...
	public void setErrorClass(String newErrorClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DYNAMIC_UNIT__ERROR_CLASS, oldErrorClass, errorClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebGenWebUIPackage.DYNAMIC_UNIT__DISPLAY_FIELDS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WebGenWebUIPackage.DYNAMIC_UNIT__SUPPORT_ACTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.DYNAMIC_UNIT__ENTITIES:
				return getEntities();
			case WebGenWebUIPackage.DYNAMIC_UNIT__DISPLAY_FIELDS:
				return getDisplayFields();
			case WebGenWebUIPackage.DYNAMIC_UNIT__SUPPORT_ACTIONS:
				return getSupportActions();
			case WebGenWebUIPackage.DYNAMIC_UNIT__HEADER:
				return getHeader();
			case WebGenWebUIPackage.DYNAMIC_UNIT__FOOTER:
				return getFooter();
			case WebGenWebUIPackage.DYNAMIC_UNIT__HEADER_CLASS:
				return getHeaderClass();
			case WebGenWebUIPackage.DYNAMIC_UNIT__CONTROL_CLASS:
				return getControlClass();
			case WebGenWebUIPackage.DYNAMIC_UNIT__FOOTER_CLASS:
				return getFooterClass();
			case WebGenWebUIPackage.DYNAMIC_UNIT__ERROR_CLASS:
