...
public abstract class UnitFeatureImpl extends UnitFieldImpl implements UnitFeature {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.UNIT_FEATURE;
	}
	...
	public EList<InlineAction> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentWithInverseEList<InlineAction>(InlineAction.class, this, WebGenWebUIPackage.UNIT_FEATURE__ACTIONS, WebGenWebUIPackage.INLINE_ACTION__USED_BY);
		}
		return actions;
	}
	...
	public void setOnlyDisplayWhenNotEmpty(boolean newOnlyDisplayWhenNotEmpty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__ONLY_DISPLAY_WHEN_NOT_EMPTY, oldOnlyDisplayWhenNotEmpty, onlyDisplayWhenNotEmpty));
	}
	...
	public void setDisplayLabel(String newDisplayLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__DISPLAY_LABEL, oldDisplayLabel, displayLabel));
	}
	...
	public void setRequired(boolean newRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__REQUIRED, oldRequired, required));
	}
	...
	public NotificationChain basicSetForcedValue(Expression newForcedValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__FORCED_VALUE, oldForcedValue, newForcedValue);
	...
	public void setForcedValue(Expression newForcedValue) {
		if (newForcedValue != forcedValue) {
			...
			if (forcedValue != null)
				msgs = ((InternalEObject)forcedValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.UNIT_FEATURE__FORCED_VALUE, null, msgs);
			if (newForcedValue != null)
				msgs = ((InternalEObject)newForcedValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebGenWebUIPackage.UNIT_FEATURE__FORCED_VALUE, null, msgs);
			msgs = basicSetForcedValue(newForcedValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__FORCED_VALUE, newForcedValue, newForcedValue));
	}
	...
	public void setNullDisplayValue(String newNullDisplayValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__NULL_DISPLAY_VALUE, oldNullDisplayValue, nullDisplayValue));
	}
	...
	public void setFooter(String newFooter) {
		...
		footer = newFooter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__FOOTER, oldFooter, footer));
	}
	...
	public void setAutofocus(boolean newAutofocus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__AUTOFOCUS, oldAutofocus, autofocus));
	}
	...
	public void setHeaderClass(String newHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__HEADER_CLASS, oldHeaderClass, headerClass));
	}
	...
	public void setInputClass(String newInputClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__INPUT_CLASS, oldInputClass, inputClass));
	}
	...
	public void setDisplayClass(String newDisplayClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__DISPLAY_CLASS, oldDisplayClass, displayClass));
	}
	...
	public void setFooterClass(String newFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.UNIT_FEATURE__FOOTER_CLASS, oldFooterClass, footerClass));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == InlineActionContainer.class) {
			switch (derivedFeatureID) {
				case WebGenWebUIPackage.UNIT_FEATURE__ACTIONS: return WebGenWebUIPackage.INLINE_ACTION_CONTAINER__ACTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == InlineActionContainer.class) {
			switch (baseFeatureID) {
				case WebGenWebUIPackage.INLINE_ACTION_CONTAINER__ACTIONS: return WebGenWebUIPackage.UNIT_FEATURE__ACTIONS;
				default: return -1;
			}
		}
