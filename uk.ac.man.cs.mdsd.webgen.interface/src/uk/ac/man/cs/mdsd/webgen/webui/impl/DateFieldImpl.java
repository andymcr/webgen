 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.DateFieldImpl#getDetails <em>Details</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.DateFieldImpl#getFormat <em>Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateFieldImpl extends InterfaceFieldImpl implements DateField {
	...
	protected EClass eStaticClass() {
		return WebGenWebUIPackage.Literals.DATE_FIELD;
	}
	...
	public void setDetails(DateDetails newDetails) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DATE_FIELD__DETAILS, oldDetails, details));
	}
	...
	public void setFormat(String newFormat) {
		...
		format = newFormat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenWebUIPackage.DATE_FIELD__FORMAT, oldFormat, format));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenWebUIPackage.DATE_FIELD__DETAILS:
				return getDetails();
			case WebGenWebUIPackage.DATE_FIELD__FORMAT:
				return getFormat();
		}
