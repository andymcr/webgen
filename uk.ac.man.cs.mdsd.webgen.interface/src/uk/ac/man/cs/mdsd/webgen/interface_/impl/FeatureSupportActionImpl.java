 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.FeatureSupportActionImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.FeatureSupportActionImpl#getConfirmMessage <em>Confirm Message</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.FeatureSupportActionImpl#getUriElement <em>Uri Element</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.interface_.impl.FeatureSupportActionImpl#getFileExtension <em>File Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureSupportActionImpl extends InlineActionImpl implements FeatureSupportAction {
	...
	protected EClass eStaticClass() {
		return WebGenInterfacePackage.Literals.FEATURE_SUPPORT_ACTION;
	}
		...
		if (operation != null && operation.eIsProxy()) {
			...
			if (operation != oldOperation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebGenInterfacePackage.FEATURE_SUPPORT_ACTION__OPERATION, oldOperation, operation));
			}
		}
		return operation;
	}
	...
	public void setOperation(BusinessOperation newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.FEATURE_SUPPORT_ACTION__OPERATION, oldOperation, operation));
	}
	...
	public void setConfirmMessage(String newConfirmMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.FEATURE_SUPPORT_ACTION__CONFIRM_MESSAGE, oldConfirmMessage, confirmMessage));
	}
	...
	public void setUriElement(String newUriElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.FEATURE_SUPPORT_ACTION__URI_ELEMENT, oldUriElement, uriElement));
	}
	...
	public void setFileExtension(String newFileExtension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenInterfacePackage.FEATURE_SUPPORT_ACTION__FILE_EXTENSION, oldFileExtension, fileExtension));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebGenInterfacePackage.FEATURE_SUPPORT_ACTION__OPERATION:
				if (resolve) return getOperation();
				return basicGetOperation();
			case WebGenInterfacePackage.FEATURE_SUPPORT_ACTION__CONFIRM_MESSAGE:
				return getConfirmMessage();
			case WebGenInterfacePackage.FEATURE_SUPPORT_ACTION__URI_ELEMENT:
				return getUriElement();
			case WebGenInterfacePackage.FEATURE_SUPPORT_ACTION__FILE_EXTENSION:
