...
public class BusinessOperationImpl extends MinimalEObjectImpl.Container implements BusinessOperation {
	...
	protected EClass eStaticClass() {
		return WebGenServicePackage.Literals.BUSINESS_OPERATION;
	}
	...
	public void setResultType(OperationResultTypes newResultType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenServicePackage.BUSINESS_OPERATION__RESULT_TYPE, oldResultType, resultType));
	}
	...
	public void setResultMimeType(String newResultMimeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebGenServicePackage.BUSINESS_OPERATION__RESULT_MIME_TYPE, oldResultMimeType, resultMimeType));
	}
