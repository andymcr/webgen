...
import uk.ac.man.cs.mdsd.webgen.persistence.util.WebGenPersistenceValidator;
 ...
 * @generated
 */
public class WebGenPersistencePackageImpl extends EPackageImpl implements WebGenPersistencePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see uk.ac.man.cs.mdsd.webgen.persistence.WebGenPersistencePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private WebGenPersistencePackageImpl() {
		super(eNS_URI, WebGenPersistenceFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link WebGenPersistencePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static WebGenPersistencePackage init() {
		if (isInited) return (WebGenPersistencePackage)EPackage.Registry.INSTANCE.getEPackage(WebGenPersistencePackage.eNS_URI);

		// Obtain or create and register package
		WebGenPersistencePackageImpl theWebGenPersistencePackage = (WebGenPersistencePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof WebGenPersistencePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new WebGenPersistencePackageImpl());
		...
		theWebGenPersistencePackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(theWebGenPersistencePackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return WebGenPersistenceValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theWebGenPersistencePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(WebGenPersistencePackage.eNS_URI, theWebGenPersistencePackage);
		return theWebGenPersistencePackage;
	}
	 ...
	 * @generated
	 */
	public WebGenPersistenceFactory getWebGenPersistenceFactory() {
		return (WebGenPersistenceFactory)getEFactoryInstance();
	}
