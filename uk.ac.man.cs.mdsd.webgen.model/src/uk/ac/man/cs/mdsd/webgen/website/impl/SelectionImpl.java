...
public class SelectionImpl extends NamedElementImpl implements Selection {
	...
	public List<FormalParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentWithInverseEList<FormalParameter>(FormalParameter.class, this, WebsitePackage.SELECTION__PARAMETERS, WebsitePackage.FORMAL_PARAMETER__FORMAL_FOR);
		}
		return parameters;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == FormalParameterList.class) {
			switch (derivedFeatureID) {
				case WebsitePackage.SELECTION__PARAMETERS: return WebsitePackage.FORMAL_PARAMETER_LIST__PARAMETERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == FormalParameterList.class) {
			switch (baseFeatureID) {
				case WebsitePackage.FORMAL_PARAMETER_LIST__PARAMETERS: return WebsitePackage.SELECTION__PARAMETERS;
				default: return -1;
			}
		}
